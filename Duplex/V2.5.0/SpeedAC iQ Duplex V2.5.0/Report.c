//Report Page - Show  Lifetime OR 1 & 2 sum
void SwitchReport2ndRow(void)
{
 ...
 if(!ReportOnCumulated)
               {
                ...
                widget_text       (REPORT_ROW8_INPUT, ProdTotalWeighmentsLT);
                widget_text       (REPORT_ROW8_UNIT,  "");
          
                // 2nd Row Info 
                
                widget_text       (REPORT_ROW9_ID, lsub(TX_ID_TOTAL_UNITS));
                widget_text       (REPORT_ROW9_INPUT, ProdTotalUnitsLT);
                widget_text       (REPORT_ROW9_UNIT,  "");
                                                 
                // Third Row Info 
                widget_text       (REPORT_ROW10_ID, lsub(TX_ID_TOTAL_WEIGHT));
                widget_text       (REPORT_ROW10_INPUT, trim(adj(ProdTotalWeightLT,14,DP[Scale1])));
                widget_text       (REPORT_ROW10_UNIT,  WP.Unit);
                
                // 4th Row Info 
                widget_text       (REPORT_ROW11_ID,"");
                widget_text       (REPORT_ROW11_INPUT, "");
                widget_text       (REPORT_ROW11_UNIT,  "");
                
                // 5th Row Info 
                widget_text       (REPORT_ROW12_ID,"");
                widget_text       (REPORT_ROW12_INPUT, "");
                widget_text       (REPORT_ROW12_UNIT,  "");
                
                // 5th Row Info 
                widget_text       (REPORT_ROW13_ID,"");
                widget_text       (REPORT_ROW13_INPUT, "");
                widget_text       (REPORT_ROW13_UNIT,  "");
                
                ReportOnCumulated = ON;
               ...
               {
                 widget_text       (REPORT_ROW14_ID, "1 + 2");
                // 1st Row Info
                widget_text       (REPORT_ROW8_ID, "");
                widget_text       (REPORT_ROW8_INPUT, "");
                widget_text       (REPORT_ROW8_UNIT,  "");
                
                // 2nd Row Info
                widget_text       (REPORT_ROW9_ID, lsub(TX_ID_UNITS_DONE));
                widget_text       (REPORT_ROW9_INPUT, trim(string(int(ProdTotalUnitsCnt[Scale1]+ProdTotalUnitsCnt[Scale2]))));
                widget_text       (REPORT_ROW9_UNIT,  "");
                                                 
                // Third Row Info 
                widget_text       (REPORT_ROW10_ID, lsub(TX_ID_UNITS_ACCEPTED));
                widget_text       (REPORT_ROW10_INPUT, trim(string(int(ProdAcceptUnitCnt[Scale1]+ProdAcceptUnitCnt[Scale2]))));
                widget_text       (REPORT_ROW10_UNIT,  "");
                                                
                // Fourth Row Info 
                widget_text       (REPORT_ROW11_ID, lsub(TX_ID_UNDERWEIGHT));
                widget_text       (REPORT_ROW11_INPUT, trim(string(int(ProdUnderWeightCnt[Scale1]+ProdUnderWeightCnt[Scale2]))));
                widget_text       (REPORT_ROW11_UNIT,  "");
                                                 
                // Fifth Row Info 
                widget_text       (REPORT_ROW12_ID, lsub(TX_ID_OVERWEIGHT));
                widget_text       (REPORT_ROW12_INPUT, trim(string(int(ProdOverWeightCnt[Scale1]+ProdOverWeightCnt[Scale2]))));
                widget_text       (REPORT_ROW12_UNIT,  "");
                                                
                // Sixth Row Info 
                widget_text       (REPORT_ROW13_ID, lsub(TX_ID_TOTAL_WEIGHT)); 
                widget_text       (REPORT_ROW13_INPUT, adj(ProdTotalWeight1+ProdTotalWeight2,14,DP[Scale1]));
                widget_text       (REPORT_ROW13_UNIT,  WP.Unit);
                
                 ReportOnCumulated = OFF;
    ...
    beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #2    // 
      ...
      beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #3  // 
        ...
        beginlayout(LAYOUT_TYPE_GRID, 0,3); // HBOX #8
          ...
          CreatePromptField (REPORT_ROW14_ID,    CL_PT_BLUE, ON, lsub(TX_ID_LIFETIME_PROD), FT_STANDARD_SIZE, WD_REPORT_DESCRIPTION3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
          widget_text_alignment (REPORT_ROW14_ID,  WIDGET_TEXT_ALIGN_CENTER );
        endlayout(); //HBOX #8
        ...
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #7
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,1); 
            ...
            beginrow(); // First row with three colons 
              ...
              CreateOutputDataField (REPORT_ROW1_INPUT2, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_REPORT_COLUMN2, HT_REPORT_BOX, widget_locked);
            ...
            beginrow(); // Second row with three colons
              ...
              CreateOutputDataField (REPORT_ROW2_INPUT2, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_REPORT_COLUMN2, HT_REPORT_BOX, widget_locked);
            ...
            beginrow(); // third row with three colons
              CreatePromptField (REPORT_ROW3_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_UNITS_ACCEPTED), FT_STANDARD_SIZE, WD_REPORT_COLUMN1, HT_REPORT_DESCRIPTION, Left_Margin, widget_locked);
              ...
              CreateOutputDataField (REPORT_ROW3_INPUT2, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_REPORT_COLUMN2, HT_REPORT_BOX, widget_locked);
            ...
            beginrow(); // Fourth row with three colons
              CreatePromptField (REPORT_ROW4_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_UNDERWEIGHT), FT_STANDARD_SIZE, WD_REPORT_COLUMN1, HT_REPORT_DESCRIPTION, Left_Margin, widget_locked);
              ...
              CreateOutputDataField (REPORT_ROW4_INPUT2, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_REPORT_COLUMN2, HT_REPORT_BOX, widget_locked);
            ...
            beginrow(); // Fifth row with three colons
              CreatePromptField (REPORT_ROW5_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_OVERWEIGHT), FT_STANDARD_SIZE, WD_REPORT_COLUMN1, HT_REPORT_DESCRIPTION, Left_Margin, widget_locked);
              ...
              CreateOutputDataField (REPORT_ROW5_INPUT2, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_REPORT_COLUMN2, HT_REPORT_BOX, widget_locked);
            ...
            beginrow(); // sixth row with three colons
              ...
              CreateOutputDataField (REPORT_ROW6_INPUT2, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_REPORT_COLUMN2, HT_REPORT_BOX, widget_locked);
        ...
        // Second Column of REPORT page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,1); // 
            ...
            beginrow(); // First row with three colons 
              CreatePromptField (REPORT_ROW8_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_TOTAL_WEIGHMENTS), FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Second row with three colons
              CreatePromptField (REPORT_ROW9_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_TOTAL_UNITS), FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Third row with three colons
              CreatePromptField (REPORT_ROW10_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_TOTAL_WEIGHT), FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Fourth row with three colons
              CreatePromptField (REPORT_ROW11_ID,    CL_PT_BLUE, OFF, "", FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputDataField (REPORT_ROW11_INPUT, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_REPORT_COLUMN4, HT_REPORT_BOX, widget_locked);
              CreateUnitField   (REPORT_ROW11_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,          "", WD_UNIT, HT_REPORT_BOX, widget_locked );
            endrow();
            
            beginrow(); // Fifth row with three colons
              CreatePromptField (REPORT_ROW12_ID,    CL_PT_BLUE, OFF, "", FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
              ...
              CreateUnitField   (REPORT_ROW12_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,          "", WD_UNIT, HT_REPORT_BOX, widget_locked );
            endrow();
            
            beginrow(); // sixth row with three colons
              CreatePromptField (REPORT_ROW13_ID,    CL_PT_BLUE, OFF, "", FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
    ...
    switch ( Scrn_No )
    {
      case SCREEN_REPORT:
          ...
          // First Column                                
               ...
               widget_text         (REPORT_ROW7_INPUT,  concat("(",lsub(WP.Name),")"));
                ...
                widget_text       (REPORT_ROW1_INPUT2, WP.NominalWeight);
                widget_text       (REPORT_ROW1_UNIT,  WP.Unit);
          
                // 2nd Row Info 
                widget_text       (REPORT_ROW2_INPUT, trim(string(int(ProdTotalUnitsCnt[Scale1]))));
                widget_text       (REPORT_ROW2_INPUT2, trim(string(int(ProdTotalUnitsCnt[Scale2]))));
                                                 
                // Third Row Info 
                widget_text       (REPORT_ROW3_INPUT, trim(string(int(ProdAcceptUnitCnt[Scale1]))));
                widget_text       (REPORT_ROW3_INPUT2, trim(string(int(ProdAcceptUnitCnt[Scale2]))));
                                                
                // Fourth Row Info 
                widget_text       (REPORT_ROW4_INPUT, trim(string(int(ProdUnderWeightCnt[Scale1]))));
                 widget_text       (REPORT_ROW4_INPUT2, trim(string(int(ProdUnderWeightCnt[Scale2]))));
                                                 
                // Fifth Row Info 
                widget_text       (REPORT_ROW5_INPUT, trim(string(int(ProdOverWeightCnt[Scale1]))));
                 widget_text       (REPORT_ROW5_INPUT2, trim(string(int(ProdOverWeightCnt[Scale2]))));
                                                
                // Sixth Row Info 
                widget_text       (REPORT_ROW6_INPUT, trim(adj(ProdTotalWeight1,14,DP[Scale1])));
                widget_text       (REPORT_ROW6_INPUT2, trim(adj(ProdTotalWeight2,14,DP[Scale2])));
      ...
      case SCREEN_BATCH:
          ...
          // Second Column                               
                ...
                // 2nd Row Info 
                widget_text       (REPORT_ROW9_INPUT, Batch.MinAccepted);
                widget_text       (REPORT_ROW9_UNIT,  WP.Unit);
                                                 
                // Third Row Info 
                widget_text       (REPORT_ROW10_INPUT, Batch.MaxAccepted);
                widget_text       (REPORT_ROW10_UNIT,  WP.Unit);
    ...
    beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #2    // 
      ...
      beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #3  // 
        ...
        beginlayout(LAYOUT_TYPE_HBOX, 0,3); // HBOX #8
          CreatePromptField (REPORT_ROW7_ID,    CL_PT_BLUE, ON, concat(lsub (TX_BATCH_CURRENT_PROD),":"), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION1, HT_BATCH_DESCRIPTION, Left_Margin, widget_locked);
          CreatePromptField (REPORT_ROW7_INPUT,    CL_PT_BLUE, OFF, concat("(",lsub(WP.Name),")"), FT_STANDARD_SIZE, WD_REPORT_DESCRIPTION2, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
          widget_text_alignment (REPORT_ROW7_INPUT,  WIDGET_TEXT_ALIGN_CENTER );
          CreatePromptField (REPORT_ROW14_ID,    CL_PT_BLUE, ON, "", FT_STANDARD_SIZE, WD_BATCH_DESCR_SPACE, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
        endlayout(); //HBOX #8
       ...
       // ##### Left display with weighing in-/outputs without infoline #####
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #7
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); 
            ...
            beginrow(); // First row with three colons 
              CreatePromptField (REPORT_BATCHNAME_ID,    CL_PT_BLUE, OFF, lsub(TX_BATCH_NAME), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Second row with three colons
              CreatePromptField (REPORT_BATCHPRESET_ID,    CL_PT_BLUE, OFF, lsub(TX_BATCH_PRESET), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // third row with three colons
              CreatePromptField (REPORT_ROW3_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_UNITS_DONE), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Fourth row with three colons
              CreatePromptField (REPORT_ROW4_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_UNITS_ACCEPTED), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Fifth row with three colons
              CreatePromptField (REPORT_ROW5_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_UNDERWEIGHT), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // sixth row with three colons
              CreatePromptField (REPORT_ROW6_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_OVERWEIGHT), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // seventh row with three colons
              CreatePromptField (REPORT_BATCHDETAILS_ID,    CL_PT_BLUE, OFF, lsub(TX_BATCH_DETAILS), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, Left_Margin, widget_locked); 
        ...
        // Second Column of REPORT page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // First row with three colons 
              CreatePromptField (REPORT_ROW8_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_TOTAL_WEIGHT), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Second row with three colons
              CreatePromptField (REPORT_ROW9_ID,    CL_PT_BLUE, OFF, lsub(TX_BATCH_MIN_ACCEPTED), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputDataField (REPORT_ROW9_INPUT, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_BATCH_BOX, HT_BATCH_BOX, widget_locked);
              CreateUnitField   (REPORT_ROW9_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,          WP.Unit, WD_UNIT, HT_BATCH_BOX, widget_locked );
            endrow();
      
            beginrow(); // Third row with three colons
              CreatePromptField (REPORT_ROW10_ID,    CL_PT_BLUE, OFF, lsub(TX_BATCH_MAX_ACCEPTED), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputDataField (REPORT_ROW10_INPUT, FT_RTC_BOLD, FT_STANDARD_SIZE, WIDGET_TEXT_ALIGN_VCENTER_R, WD_BATCH_BOX, HT_BATCH_BOX, widget_locked);
              CreateUnitField   (REPORT_ROW10_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,          WP.Unit, WD_UNIT, HT_BATCH_BOX, widget_locked);
            endrow();
            
            beginrow(); // Fourth row with three colons
              CreatePromptField (REPORT_ROW11_ID,    CL_PT_BLUE, OFF, lsub(TX_BATCH_RESIDUE), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Fifth row with three colons
              CreatePromptField (REPORT_ROW12_ID,    CL_PT_BLUE, OFF, lsub(TX_STD_DEV), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // sixth row with three colons
              CreatePromptField (REPORT_ROW13_ID,    CL_PT_BLUE, OFF, lsub(TX_AVERAGE), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // sixth row with three colons
              CreatePromptField (REPORT_BATCHCOUNTALL_ID,    CL_PT_BLUE, OFF, lsub(TX_BATCH_COUNTALL), FT_STANDARD_SIZE, WD_BATCH_DESCRIPTION, HT_BATCH_DESCRIPTION, No_Margin, widget_locked);
              CreateOnOffBoxField   (REPORT_BATCHCOUNTALL_INPUT, 25, WIDGET_TEXT_ALIGN_CENTER, ON, BTN_CHECKON_SMALL, BTN_CHECKOFF_SMALL);
...
endlayout(); //Test Layout #1
   ...
   createwidget (0, WIDGET_TYPE_STRETCH);
    ...
    CreateNavigButtons (10, NAV_FCT_BUTTON_1, OFF);
    DrawNavButtons (SCREEN_BATCH, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_REPORTRESET);  
