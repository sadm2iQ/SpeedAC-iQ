...
#define BTN_1                   concat(DIRECTORY, "BTN_1.png")
#define BTN_2                   concat(DIRECTORY, "BTN_2.png")
#define BTN_1W                  concat(DIRECTORY, "BTN_1_WHITE.png")
#define BTN_2W                  concat(DIRECTORY, "BTN_2_WHITE.png")
...
#define BTN_DISCH_PAN           concat(DIRECTORY, "BTN_DISCH_PAN.png")
...
#define BTN_SYSTEM_CLEAN        concat(DIRECTORY, "SYSTEM - CLEAN.png")  
#define BTN_SYSTEM_CLEAN_ON     concat(DIRECTORY, "SYSTEM - CLEAN ON.png") 
