       ...
       beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #5 Header
        ...
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #1
            beginrow(); // First row with two columns 
              CreatePromptField (FLEX_ROW5_UNIT, CL_PT_BLUE, ON, concat (lsub(TX_OUTPUT), space(1),"1", space(1), lsub(TX_ON)), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked );
            endrow();
            
            beginrow(); // Second row with two columns
              CreatePromptField (FLEX_ROW1_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIOTYPE), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Third row with three columns
              CreatePromptField (FLEX_ROW2_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXSETPOINT), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Fourth row with two columns
              CreatePromptField (FLEX_ROW4_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIO), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Fifth row with two columns
              CreatePromptField (FLEX_ROW5_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXSWITCH), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked); 
            ...
            beginrow(); // Sixth row with two columns
              CreatePromptField (FLEX_ROW6_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXTIMER), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
        ...
        // Second Column  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #2
            beginrow(); // First row with two columns 
              CreatePromptField (FLEX_ROW11_UNIT,    CL_PT_BLUE, ON,      concat (lsub(TX_OUTPUT), space(1),"1", space(1),lsub(TX_OFF)), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked );
            endrow();
            
            beginrow(); // Second row with two columns
              CreatePromptField (FLEX_ROW7_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIOTYPE), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Third row with three columns
              CreatePromptField (FLEX_ROW8_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXSETPOINT), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, 0, widget_locked);
               beginlayout(LAYOUT_TYPE_HBOX, 0);
                beginrow();
            ...
            beginrow(); // Fourth row with two columns
              CreatePromptField (FLEX_ROW10_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIO), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
              CreateLanguageListField (FLEX_ROW10_INPUT, FT_RTC_BOLD, WIDGET_TEXT_ALIGN_CENTER,                                                 "", WD_FLEXIO_BOX, HT_FLEXIO_BOX, widget_locked);
            endrow();

            beginrow(); // Fifth row with two columns
              CreatePromptField (FLEX_ROW11_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXSWITCH), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Sixth row with two columns
              CreatePromptField (FLEX_ROW12_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXTIMER), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
...
endlayout();  // End layout of Test Layout #1
   ...
   DrawNavButtons (SCREEN_FLEXIO_1, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_TIMEDATE, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NEXT);     
      ...
      beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #3  
       ...
       beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #5 Header
        ...
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #1
            beginrow(); // First row with two columns 
              CreatePromptField (FLEX_ROW17_UNIT,    CL_PT_BLUE, ON,       concat (lsub(TX_OUTPUT), space(1),"2", space(1),lsub(TX_ON)), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked );
            endrow();
            
            beginrow(); // Second row with two columns
              CreatePromptField (FLEX_ROW13_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIOTYPE), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Third row with three columns
              CreatePromptField (FLEX_ROW14_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXSETPOINT), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
               beginlayout(LAYOUT_TYPE_HBOX, 0);
                beginrow();
            ...
            beginrow(); // Fourth row with two columns
              CreatePromptField (FLEX_ROW16_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIO), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
              CreateLanguageListField (FLEX_ROW16_INPUT, FT_RTC_BOLD, WIDGET_TEXT_ALIGN_CENTER,                                                 "", WD_FLEXIO_BOX, HT_FLEXIO_BOX, widget_locked);
            endrow();

            beginrow(); // Fifth row with two columns
              CreatePromptField (FLEX_ROW17_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXSWITCH), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Sixth row with two columns
              CreatePromptField (FLEX_ROW18_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXTIMER), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
        ...
        // Second Column  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #2
            beginrow(); // First row with two columns 
              CreatePromptField (FLEX_ROW23_UNIT,    CL_PT_BLUE, ON,      concat (lsub(TX_OUTPUT), space(1),"2", space(1),lsub(TX_OFF)), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked );
            endrow();
            
            beginrow(); // Second row with two columns
              CreatePromptField (FLEX_ROW19_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIOTYPE), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Third row with three columns
              CreatePromptField (FLEX_ROW20_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXSETPOINT), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
               beginlayout(LAYOUT_TYPE_HBOX, 0);
                beginrow();
            ...
            beginrow(); // Fourth row with two columns
              CreatePromptField (FLEX_ROW22_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIO), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
              beginlayout(LAYOUT_TYPE_HBOX, 0);
                beginrow();
            ...
            beginrow(); // Fifth row with two columns
              CreatePromptField (FLEX_ROW23_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXSWITCH), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);                 
            ...
            beginrow(); // Sixth row with two columns
              CreatePromptField (FLEX_ROW24_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXTIMER), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
...
endlayout();  // End layout of Test Layout #1
   ...
   CreateNavigButtons (10, NAV_FCT_BUTTON_1, OFF);
   DrawNavButtons (SCREEN_FLEXIO_2, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_PREV, BTN_NIL_BLUE);     
    ...
    beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #2    
      ...
      beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #3  
        ...
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
           ...
           beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #1
            beginrow(); // First row with two columns 
              CreatePromptField     (FLEX_ROW29_UNIT,    CL_PT_BLUE, ON,                   lsub(TX_FLEXCONFIG), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            endrow();
            
            beginrow(); // Second row with two columns
              CreatePromptField (FLEX_ROW25_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXCNTMODE), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // third row with two columns
              CreatePromptField (FLEX_ROW26_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIOTYPE), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Fourth row with two columns
              CreatePromptField (FLEX_ROW27_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXIO), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
              CreateLanguageListField (FLEX_ROW27_INPUT, FT_RTC_BOLD, WIDGET_TEXT_ALIGN_CENTER,                                                 "", WD_FLEXIO_BOX, HT_FLEXIO_BOX, widget_locked);
            endrow();

            beginrow(); // Fifth row with two columns
              CreatePromptField (FLEX_ROW28_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXPRESOURCE), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Sixth row with two columns 
              CreatePromptField     (FLEX_ROW29_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, Left_Margin, widget_locked);
...
//          CreatePromptField (RECIPE_SPACE1,    CL_PT_BLUE, OFF,                       "", FT_STANDARD_SIZE, WD_FLEX_SPACE, PT_6BOX_SIZE, No_Margin, widget_locked);

        // Second Column  
           
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #2
            beginrow(); // First row with two columns 
              CreatePromptField (FLEX_ROW35_UNIT,    CL_PT_BLUE, ON,                       lsub(TX_FLEXTIMERS), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked );
            endrow();
            
            beginrow(); // Second row with two columns
              CreatePromptField (FLEX_ROW31_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXINITDELAY), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (FLEX_ROW31_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_FLEXINITDELAY), WD_FLEXIOCNT_BOX, HT_FLEXIO_BOX, widget_locked );
              CreateUnitField   (FLEX_ROW31_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,            lsub(TX_SEC_UNIT), WD_FLEX_SECONDS, PT_6BOX_SIZE, widget_locked );
            endrow();
            
            beginrow(); // Third row with two columns
              CreatePromptField (FLEX_ROW32_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXONTIME), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (FLEX_ROW32_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_FLEXONTIME), WD_FLEXIOCNT_BOX, HT_FLEXIO_BOX, widget_locked );
              CreateUnitField   (FLEX_ROW32_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,            lsub(TX_SEC_UNIT), WD_FLEX_SECONDS, PT_6BOX_SIZE, widget_locked );
            endrow();

            beginrow(); // Fourth row with two columns
              CreatePromptField (FLEX_ROW33_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXOFFTIME), FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (FLEX_ROW33_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_FLEXOFFTIME), WD_FLEXIOCNT_BOX, HT_FLEXIO_BOX, widget_locked );
              CreateUnitField   (FLEX_ROW33_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,            lsub(TX_SEC_UNIT), WD_FLEX_SECONDS, PT_6BOX_SIZE, widget_locked );
            endrow();

            beginrow(); // Fifth row with two columns
              CreatePromptField     (FLEX_ROW35_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputTextField (FLEX_ROW35_SELECT,                                     "", WD_FLEXIOCNT_BOX, HT_FLEXIO_BOX, widget_locked);
            endrow();

            beginrow(); // Sixth row with two columns
              CreatePromptField     (FLEX_ROW36_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_FLEXIO_DESCRIPTION, HT_FLEXIO_DESCRIPTION, No_Margin, widget_locked);
...
endlayout();  // End layout of Test Layout #1
   ...
   CreateNavigButtons (10, NAV_FCT_BUTTON_1, OFF);
   DrawNavButtons (SCREEN_FLEXIO_3, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_PREV, BTN_NIL_BLUE);     
...
{
int     i=0,j, Index_No[MAX_IO]=0, result ,ID_GENERIC_DBASE_LIST;
...
switch (Scrn_No)
{
 case SCREEN_FLEXIO_1:
                   ...
                   // Output 1 ON 
                     ...
                     FlexIO_Grayout[2]=(FlexIO_Type[Flex_Out1][FlexOutput_ON] < Flex_Setpoint1  || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);  
                     FlexIO_Grayout[3]=(FlexIO_Type[Flex_Out1][FlexOutput_ON] < Flex_Setpoint1  || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);   
                     FlexIO_Grayout[4]=(FlexIO_Type[Flex_Out1][FlexOutput_ON] >= Flex_Setpoint1 || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);
                     FlexIO_Grayout[5]=(FlexIO_Type[Flex_Out1][FlexOutput_ON] >= Flex_Setpoint1 || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);
                     FlexIO_Grayout[6]=(mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);
                     
                   // Output 1 OFF  
                     FlexIO_Grayout[7]=(mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);
                     FlexIO_Grayout[8]= (FlexIO_Type[Flex_Out1][FlexOutput_OFF] < Flex_Setpoint1  || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);  
                     FlexIO_Grayout[9]= (FlexIO_Type[Flex_Out1][FlexOutput_OFF] < Flex_Setpoint1  || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);  
                     FlexIO_Grayout[10]=(FlexIO_Type[Flex_Out1][FlexOutput_OFF] >= Flex_Setpoint1 || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);
                     FlexIO_Grayout[11]=(FlexIO_Type[Flex_Out1][FlexOutput_OFF] >= Flex_Setpoint1 || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_1]);
 ...
 case SCREEN_FLEXIO_2:
                   ...
                   // Output 2 ON 
                     ...
                     FlexIO_Grayout[14]=(FlexIO_Type[Flex_Out2][FlexOutput_ON] < Flex_Setpoint1  || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_2]);  
                     FlexIO_Grayout[15]=(FlexIO_Type[Flex_Out2][FlexOutput_ON] < Flex_Setpoint1  || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_2]); 
                     FlexIO_Grayout[16]=(FlexIO_Type[Flex_Out2][FlexOutput_ON] >= Flex_Setpoint1 || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_2]);
                     FlexIO_Grayout[17]=(FlexIO_Type[Flex_Out2][FlexOutput_ON] >= Flex_Setpoint1 || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_2]);
                   ...
                   // Output 2 OFF  
                     ...
                     FlexIO_Grayout[20]=(FlexIO_Type[Flex_Out2][FlexOutput_OFF] < Flex_Setpoint1  || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_2]);  
                     FlexIO_Grayout[21]=(FlexIO_Type[Flex_Out2][FlexOutput_OFF] < Flex_Setpoint1  || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_2]);  
                     FlexIO_Grayout[22]=(FlexIO_Type[Flex_Out2][FlexOutput_OFF] >= Flex_Setpoint1 || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_2]);
                     FlexIO_Grayout[23]=(FlexIO_Type[Flex_Out2][FlexOutput_OFF] >= Flex_Setpoint1 || mode_step != stp_OFF_MODE || !IO_Enable[O_FlexIO_2]);
 ...
 j=pointer;
 TEST_ID[0]     = string(FLEX_ROW1_ID+j);
 TEST_VALUE[0]  = string(FLEX_ROW1_INPUT+j);
 TEST_SELECT[0] = string(FLEX_ROW1_SELECT+j);
 ...
 for (i=0; i<MaxRows; i++)
     {
      ...
      widget_enable     (TEST_ID[i],     !FlexIO_Grayout[i+j+1]);
      widget_enable     (TEST_VALUE[i],  !FlexIO_Grayout[i+j+1]);
      widget_enable     (TEST_SELECT[i], !FlexIO_Grayout[i+j+1]);
     }
} 
  ...
  switch ( Scrn_No )
  {
    case SCREEN_FLEXIO_1 :  
                  ...
                  // Output 1 ON                                
                    ...
                    if ((FlexIO_Type[Flex_Out1][FlexOutput_ON]==Flex_Input && FlexIO_IOEnum[Flex_Out1][FlexOutput_ON] <=NUMBEROFINPUTS ) || (FlexIO_Type[Flex_Out1][FlexOutput_ON]==Flex_Output && FlexIO_IOEnum[Flex_Out1][FlexOutput_ON] > NUMBEROFINPUTS ))
                    {
                  ...
                  // Output 1 OFF
                    ...
                    if ((FlexIO_Type[Flex_Out1][FlexOutput_OFF]==Flex_Input && FlexIO_IOEnum[Flex_Out1][FlexOutput_OFF] <=NUMBEROFINPUTS ) || (FlexIO_Type[Flex_Out1][FlexOutput_OFF]==Flex_Output && FlexIO_IOEnum[Flex_Out1][FlexOutput_OFF] > NUMBEROFINPUTS ))
                    {                      
    ...
    case SCREEN_FLEXIO_2 :    
                  ...
                  // Output 2 ON                                
                    ...
                    if ((FlexIO_Type[Flex_Out2][FlexOutput_ON]==Flex_Input && FlexIO_IOEnum[Flex_Out2][FlexOutput_ON] <=NUMBEROFINPUTS ) || (FlexIO_Type[Flex_Out2][FlexOutput_ON]==Flex_Output && FlexIO_IOEnum[Flex_Out2][FlexOutput_ON] > NUMBEROFINPUTS ))
                    {
                 ...
                 // Output 2 OFF
                    ...
                    if ((FlexIO_Type[Flex_Out2][FlexOutput_OFF]==Flex_Input && FlexIO_IOEnum[Flex_Out2][FlexOutput_OFF] <=NUMBEROFINPUTS ) || (FlexIO_Type[Flex_Out2][FlexOutput_OFF]==Flex_Output && FlexIO_IOEnum[Flex_Out2][FlexOutput_OFF] > NUMBEROFINPUTS ))
                    {
    ...
    case SCREEN_FLEXIO_3 :    
                  ...
                  // Output 3 ON                                
                    ...
                    if ((FlexIO_Type[Flex_Out3][FlexOutput_ON]==Flex_Input && FlexIO_IOEnum[Flex_Out3][FlexOutput_ON] <=NUMBEROFINPUTS ) || (FlexIO_Type[Flex_Out3][FlexOutput_ON]==Flex_Output && FlexIO_IOEnum[Flex_Out3][FlexOutput_ON] > NUMBEROFINPUTS ))
                    {
...
--  Side Effects      : 
--------------------------------------------------------------------------*/
bool Flex_SetpointTest (int i, int j,int ScaleNo)
{
  
  if (FlexIO_SPSign[i][j])
  {
    if (NetWeight[ScaleNo-1] >= FlexIO_SP_Pre[i][j])
    {
    FlexIO_TestOnFlag[i][j] = ON;
    return (ON);
    }
    else if (NetWeight[ScaleNo-1] < FlexIO_SP_Pre[i][j] && FlexIO_SetOnFlag[i][j]) 
...
{
int i,j,k=0,l; 
bool output_status,Test_IO = OFF, Test_SP1 = OFF, Test_SP2 = OFF,
     return_SP, valid = OFF; 
j = 0;
...
for (i=0; i<Flex_Out3; i++) /* FlexIO # */
{
  ...
  {    
    ...
    Test_SP1 = (FlexIO_Type[i][j] == Flex_Setpoint1);
    Test_SP2 = (FlexIO_Type[i][j] == Flex_Setpoint2);
                          ...
                          if (output_status ) // OFF 
                          {
                            if (Test_IO) 
                            {
                              valid = (Flex_IOTest(i,j,k)); //OFF
                                 ...
                                 {  
                                   valid = (Flex_SetpointTest(i,j,1)); //OFF
                                 } 
                            else if (Test_SP2) 
                                 {  
                                   valid = (Flex_SetpointTest(i,j,2)); //OFF
                                 }       
...
{
int i,j,k=0,l; 
bool output_status,Test_Pulsing = OFF, Test_IO,
     return_SP, valid = OFF; 
