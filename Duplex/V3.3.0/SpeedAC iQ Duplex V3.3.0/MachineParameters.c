...
void CreateMPPage1(void) 
{
  ...
  beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #1
      ...
      beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #3  
       ...
       // Left display with weighing in-/outputs without infoline
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #1
            beginrow(); // First row with three columns 
              CreatePromptField (MP_ROW1_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPSAMPLEFREQUENCY), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked );
              CreateInputField  (MP_ROW1_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 7, 0, OFF, lsub(TX_MPSAMPLEFREQUENCY), WD_MP_BOX, HT_MP_BOX, widget_locked );
            ...
            beginrow(); // Second row with three columns
              CreatePromptField (MP_ROW2_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPSAMPLESIZE), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (MP_ROW2_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 0, OFF, lsub(TX_MPSAMPLESIZE), WD_MP_BOX, HT_MP_BOX, widget_locked );
            ...
            beginrow(); // Thirth row with three columns
              CreatePromptField (MP_ROW3_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MPZEROFREQUENCY), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (MP_ROW3_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 7, 0, OFF, lsub(TX_MPZEROFREQUENCY), WD_MP_BOX, HT_MP_BOX, widget_locked );
            ...
            beginrow(); // Fourth row with three columns
              CreatePromptField (MP_ROW4_ID,    CL_PT_BLUE, OFF,                       lsub(TX_MPZEROLIMIT), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (MP_ROW4_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_MPZEROLIMIT), WD_MP_BOX, HT_MP_BOX, widget_locked );
            ...
            beginrow(); // Fifth row with three columns
              CreatePromptField   (MP_ROW5_ID,     CL_PT_BLUE, OFF,                    lsub(TX_MPAUTOZEROOFF), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Sixth row with three columns
              CreatePromptField     (MP_ROW6_ID,     CL_PT_BLUE, OFF,                  lsub(TX_MPSCREENSAVERTIME), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField      (MP_ROW6_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 2, 0, OFF, lsub(TX_MPSCREENSAVERTIME), WD_MP_BOX, HT_MP_BOX, widget_locked );
        ...
        // Spacing between columns
          CreatePromptField (MP_SPACE1,    CL_PT_BLUE, OFF,                       "", FT_STANDARD_SIZE, WD_MP_SPACE, HT_MP_DESCRIPTION, No_Margin, widget_locked);
        
        // Second Column of recipe page  
           
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #2
            beginrow(); // First row with three columns 
              CreatePromptField (MP_ROW7_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPDISCHDOORMAXTIME) , FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW7_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 2, OFF, lsub(TX_MPDISCHDOORMAXTIME), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW7_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                              lsub(TX_SEC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked);
            endrow();     
            
            beginrow(); // Second row with three columns
              CreatePromptField (MP_ROW8_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPSLOWCYCLETIME), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW8_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 2, OFF, lsub(TX_MPSLOWCYCLETIME), WD_MP_BOX, HT_MP_BOX, widget_locked );
            ...
            beginrow(); // Third row with three columns 
              CreatePromptField (MP_ROW9_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPCATCHGATEMAXTIME) , FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW9_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 2, OFF, lsub(TX_MPCATCHGATEMAXTIME), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW9_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                              lsub(TX_SEC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();                              
          
            beginrow(); // Fourth row with three columns  
              CreatePromptField (MP_ROW10_ID,    CL_PT_BLUE, OFF,                       lsub(TX_MPOUTOFTOLTIME) , FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW10_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 7, 2, OFF, lsub(TX_MPOUTOFTOLTIME), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW10_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                             lsub(TX_SEC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();            

            beginrow(); // Fifth row with three columns 
              CreatePromptField (MP_ROW11_ID,    CL_PT_BLUE, OFF,                       lsub(TX_MPBAGDETECTIONTIME) , FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW11_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 2, OFF, lsub(TX_MPBAGDETECTIONTIME), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW11_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                             lsub(TX_SEC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();  

            beginrow(); // Sixth row with three columns
              CreatePromptField (MP_ROW12_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPSTABTIMELIMIT), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW12_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 2, OFF, lsub(TX_MPSTABTIMELIMIT), WD_MP_BOX, HT_MP_BOX, widget_locked );
   ...
   DrawNavButtons (SCREEN_MP1, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_TIMEDATE, BTN_NIL_BLUE, BTN_NEXT, BTN_NIL_BLUE, BTN_NIL_BLUE);     
       ...
       // Left display with weighing in-/outputs without infoline
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); 
            beginrow(); // First row with three columns 
              CreatePromptField   (MP_ROW13_ID,     CL_PT_BLUE, OFF,                    lsub(TX_MPCORRECTIONONAVERAGE), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Second row with three columns
              CreatePromptField (MP_ROW14_ID,    CL_PT_BLUE, OFF,                       lsub(TX_MPCUTOFFCORRECTIONLIMIT), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (MP_ROW14_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_MPCUTOFFCORRECTIONLIMIT), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW14_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                             lsub(TX_PERC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();
            
            beginrow(); // Thirth row with three columns
              CreatePromptField (MP_ROW15_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPDFWEIGHTCORRECTION), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (MP_ROW15_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 3, 1, OFF, lsub(TX_MPDFWEIGHTCORRECTION), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW15_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                              lsub(TX_PERC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();   
                     
            beginrow(); // Fourth row with three columns
              CreatePromptField (MP_ROW16_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPCUTOFFCORRECTION), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (MP_ROW16_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 6, 2, OFF, lsub(TX_MPCUTOFFCORRECTION), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW16_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                              lsub(TX_PERC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked ); 
            endrow();

            beginrow(); // Fifth row with three columns
              CreatePromptField     (MP_ROW17_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateOutputTextField (MP_ROW17_INPUT,                                      "", WD_MP_BOX, HT_MP_BOX, widget_locked);
              CreateUnitField       (MP_ROW17_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,       "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();

            beginrow(); // Sixth row with three columns
              CreatePromptField     (MP_ROW18_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateOutputTextField (MP_ROW18_INPUT,                                      "", WD_MP_BOX, HT_MP_BOX, widget_locked);
              CreateUnitField       (MP_ROW18_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,       "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // First row with three columns 
              CreatePromptField (MP_ROW19_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MPSLOWFILTER), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW19_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 2, 0, OFF, lsub(TX_MPSLOWFILTER), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW19_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();     
            
            beginrow(); // Second row with three columns  
              CreatePromptField (MP_ROW20_ID,    CL_PT_BLUE, OFF,                       lsub(TX_MPFASTFILTER), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW20_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 2, 0, OFF, lsub(TX_MPFASTFILTER), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW20_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                             "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();    
            
            beginrow(); // Third row with three columns 
              CreatePromptField (MP_ROW21_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MPFLASHFILTER), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW21_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 2, 0, OFF, lsub(TX_MPFLASHFILTER), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField   (MP_ROW21_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();                              
          
            beginrow(); // Fourth row with three columns  
              CreatePromptField  (MP_ROW22_ID,     CL_PT_BLUE, OFF,                  lsub(TX_MPSTDFILTER), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField   (MP_ROW22_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 2, 0, OFF, lsub(TX_MPSTDFILTER), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField    (MP_ROW22_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();            

            beginrow(); // Fifth row with three columns 
              CreatePromptField  (MP_ROW23_ID,     CL_PT_BLUE, OFF,                  lsub(TX_MPSMARTSTABWINDOW), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField   (MP_ROW23_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 3, 1, OFF, lsub(TX_MPSMARTSTABWINDOW), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField    (MP_ROW23_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();  

            beginrow(); // Sixth row with three columns
              CreatePromptField     (MP_ROW24_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
...
//        createwidget (ID_STRETCH, WIDGET_TYPE_STRETCH);  // Set max distance between entries and infoline          
   ...
   CreateNavigButtons (10, NAV_FCT_BUTTON_1, OFF);
   DrawNavButtons (SCREEN_MP2, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_NIL_BLUE, BTN_PREV, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE);     
      ...
      beginlayout(LAYOUT_TYPE_HBOX, 0); // Header
       ...
       // Left display with weighing in-/outputs without infoline
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); 
           beginrow(); // First row with three columns 
              CreatePromptField     (MP_ROW25_ID,     CL_PT_BLUE, OFF,                  lsub(TX_MPT1), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField      (MP_ROW25_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 3, OFF, lsub(TX_MPT1), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField       (MP_ROW25_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                        lsub(TX_SEC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();     
            
            beginrow(); // Second row with three columns  
              CreatePromptField     (MP_ROW26_ID,     CL_PT_BLUE, OFF,                  lsub(TX_MPT2), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField      (MP_ROW26_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 3, OFF, lsub(TX_MPT2), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField       (MP_ROW26_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                        lsub(TX_SEC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();    
            
            beginrow(); // Third row with three columns 
              CreatePromptField     (MP_ROW27_ID,    CL_PT_BLUE, OFF,                        lsub(TX_FLEXCOUNTER) , FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField      (MP_ROW27_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 2, OFF, lsub(TX_FLEXCOUNTER), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField       (MP_ROW27_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                              "#", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();                              
          
            beginrow(); // Fourth row with three columns  
              CreatePromptField     (MP_ROW28_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateOutputTextField (MP_ROW28_INPUT,                                      "", WD_MP_BOX, HT_MP_BOX, widget_locked);
              CreateUnitField       (MP_ROW28_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,       "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();            

            beginrow(); // Fifth row with three columns 
              CreatePromptField     (MP_ROW29_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Sixth row with three columns
              CreatePromptField     (MP_ROW30_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // First row with three columns 
              CreatePromptField     (MP_ROW31_ID,    CL_PT_BLUE, OFF,                   lsub(TX_MPSP1) , FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField      (MP_ROW31_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 3, OFF, lsub(TX_MPSP1), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField       (MP_ROW31_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         WP.Unit, WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();     
            
            beginrow(); // Second row with three columns  
              CreatePromptField     (MP_ROW32_ID,    CL_PT_BLUE, OFF,                   lsub(TX_MPSP2) , FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField      (MP_ROW32_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 3, OFF, lsub(TX_MPSP2), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField       (MP_ROW32_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         WP.Unit, WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();    
            
             beginrow(); // Second row with three columns  
              CreatePromptField     (MP_ROW33_ID,     CL_PT_BLUE, OFF,                  lsub(TX_BSFBULKDELAY), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField      (MP_ROW33_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 3, OFF, lsub(TX_BSFBULKDELAY), WD_MP_BOX, HT_MP_BOX, widget_locked );
              CreateUnitField       (MP_ROW33_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                        lsub(TX_SEC_UNIT), WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();    
            
            beginrow(); // Fourth row with three columns  
              CreatePromptField     (MP_ROW34_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputTextField (MP_ROW34_INPUT,                                      "", WD_MP_BOX, HT_MP_BOX, widget_locked);
              CreateUnitField       (MP_ROW34_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,       "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow();            

            beginrow(); // Fifth row with three columns 
              CreatePromptField     (MP_ROW35_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Sixth row with three columns
              CreatePromptField     (MP_ROW36_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
...
//        createwidget (ID_STRETCH, WIDGET_TYPE_STRETCH);  // Set max distance between entries and infoline          
   ...
   CreateNavigButtons (10, NAV_FCT_BUTTON_1, OFF);
   DrawNavButtons (SCREEN_MP3, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_NIL_BLUE, BTN_PREV, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE);     
...
void CreateMPPage4(void) 
{
  ...
  beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #1
       ...
       // Left display with weighing in-/outputs without infoline
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
         ...
         createwidget (ID_STRETCH, WIDGET_TYPE_STRETCH);
          beginlayout(LAYOUT_TYPE_GRID, 0); 
            beginrow(); // First row with three columns 
              CreatePromptField     (MP_ROW37_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, 20, Left_Margin, widget_locked);
            endrow();
            beginrow(); // Second row with three columns  
              CreatePromptField     (MP_ROW38_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, HT_MP_BOX, Left_Margin, widget_locked);
            endrow();
            beginrow(); // Third row with three columns  
            ...
            endrow(); 
            beginrow(); // Fourth row with three columns 
              CreatePromptField   (MP_ROW39_ID,     CL_PT_BLUE, OFF,                      lsub(TX_SaveMP2Def), FT_STANDARD_SIZE, WD_MP_PAGE4, HT_MP_BOX, Left_Margin, widget_locked);
              widget_text_alignment (MP_ROW39_ID,  WIDGET_TEXT_ALIGN_CENTER);
            endrow();           
            beginrow(); // Fifth row with three columns  
              CreatePromptField     (MP_ROW40_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, 20, Left_Margin, widget_locked);
            endrow();
            beginrow(); // Sixth row with three columns  
              CreatePromptField     (MP_ROW41_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, 20, Left_Margin, widget_locked);
            endrow();
            beginrow(); // Seventh row with three columns  
              CreatePromptField     (MP_ROW42_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, 20, Left_Margin, widget_locked);
            endrow();
        ...
        // Second Column of recipe page  
         createwidget (ID_STRETCH, WIDGET_TYPE_STRETCH); 
          beginlayout(LAYOUT_TYPE_GRID, 0); // 
            beginrow(); // First row with three columns 
              CreatePromptField     (MP_ROW43_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, 20, No_Margin, widget_locked);
            endrow();
            beginrow(); // Second row with three columns 
              CreatePromptField     (MP_ROW44_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, HT_MP_BOX, No_Margin, widget_locked);
            endrow();
            beginrow(); // Third row with three columns 
            ...
            endrow();
            beginrow(); // Fourth row with three columns 
              CreatePromptField   (MP_ROW45_ID,     CL_PT_BLUE, OFF,                      lsub(TX_RestDef2MP), FT_STANDARD_SIZE, WD_MP_PAGE4, HT_MP_BOX, No_Margin, widget_locked);
              widget_text_alignment (MP_ROW45_ID,  WIDGET_TEXT_ALIGN_CENTER);
            endrow();
            beginrow(); // Fifth row with three columns 
              CreatePromptField     (MP_ROW46_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, 20, No_Margin, widget_locked);
            endrow();
            beginrow(); // Sixth row with three columns 
              CreatePromptField     (MP_ROW47_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, 20, No_Margin, widget_locked);
            endrow();
            beginrow(); // Seventh row with three columns 
              CreatePromptField     (MP_ROW48_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_PAGE4, 20, No_Margin, widget_locked);
            endrow();     
   ...
   CreateNavigButtons (10, NAV_FCT_BUTTON_1, OFF);
   DrawNavButtons (SCREEN_MP4, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_NIL_BLUE, BTN_PREV, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE);     
...
int i, j ;
j=pointer;
TEST_ID[0]     = string(MP_ROW1_ID+j);
TEST_VALUE[0]  = string(MP_ROW1_INPUT+j);
TEST_SELECT[0] = string(MP_ROW1_SELECT+j);
 ...
 for (i=0; i<MaxRows; i++)
     {
      ...
      widget_enable     (TEST_ID[i],     !MP_Grayout[i+j+1]);
      widget_enable     (TEST_VALUE[i],  !MP_Grayout[i+j+1]);
      widget_enable     (TEST_SELECT[i], !MP_Grayout[i+j+1]);
  ...
  switch ( Scrn_No )
  {
    case SCREEN_MP1 :  
                  ...
                  // Second Column                               
                    ...
                    widget_text (MP_ROW9_INPUT, MP.CatchGateMaxTime);
                    widget_text (MP_ROW10_INPUT, MP.OutOfTolTime);
                    widget_text (MP_ROW11_INPUT, MP.BagDetectionTime);
    ...
    case SCREEN_MP2 :    
                  ...
                  // First Column
                   ...
                   // Second Column                               
                    widget_text      (MP_ROW19_INPUT,  MP.SlowFilterSize);
                    widget_text      (MP_ROW20_INPUT,  MP.FastFilterSize);
                    widget_text      (MP_ROW21_INPUT,  MP.FlashFilterSize);
                    widget_text      (MP_ROW22_INPUT,  MP.StdFilterSize); 
                    widget_text      (MP_ROW23_INPUT,  MP.SmartStabWindow);                 
    ...
    case SCREEN_MP3 :    
                  ...
                  // First Column                              
                   ...
                   // Second Column                                                     
                    ...
                    widget_text      (MP_ROW33_INPUT,  MP.BSFBulkOffDelay);
  ...
  {  
    case SCREEN_MP1 :  
                   ...
                   // Page 1 of 2
                      ...
                      case MP_ROW4_INPUT : MP.ZeroLimit = decimal (Lim(0,100,Argument));
                                            break; 
                      ...
                      case MP_ROW9_INPUT :  MP.CatchGateMaxTime = decimal (Lim(0,5,Argument));
                                            break;
                                     
                      case MP_ROW10_INPUT : MP.OutOfTolTime = decimal (Lim(0,1200,Argument));
                                            break; 
                                     
                      case MP_ROW11_INPUT : MP.BagDetectionTime = decimal (Lim(0,60,Argument));
                                            break;
    ...
    case SCREEN_MP2 :  
                   ...
                   // Page 2 of 2                          
                      ...
                      case MP_ROW19_INPUT : MP.SlowFilterSize = decimal (Lim((MP.FastFilterSize + 1),40,Argument));
                                            break;                      
                       
                      case MP_ROW20_INPUT : MP.FastFilterSize = decimal (Lim(1,(MP.SlowFilterSize - 1),Argument));
                                            break;
                                            
                      case MP_ROW21_INPUT : MP.FlashFilterSize = decimal (Lim(1,40,Argument));
                                            break;
                                            
                      case MP_ROW22_INPUT : MP.StdFilterSize = decimal (Lim((SMFilterSize-5),(SMFilterSize+5),Argument));
                                            break;
                                            
                      case MP_ROW23_INPUT : MP.SmartStabWindow = decimal (Lim(0.5,3,Argument));
                                            break;                      
    ...
    case SCREEN_MP3 :  
                   ...
                   // Page 3 of 3                          
                      ...
                      case MP_ROW33_INPUT : MP.BSFBulkOffDelay = decimal (Lim(0, 9.99,Argument));
                                            break;                     
...
beginlayout(LAYOUT_TYPE_HBOX, 0); 
        ...
        beginlayout(LAYOUT_TYPE_HBOX, 0); //HBOX #2
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0); // GRID #1
              ...
              beginrow(); // First row "Blank" with 2 columns             
                CreatePromptField   (TDMANAGE_DAY_ID,     CL_PT_BLUE, OFF, lsub(TX_TDMANAGE_DAY_ID), FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_locked); 
              ...
              beginrow(); // Second row with two columns
                CreatePromptField   (TDMANAGE_HOUR_ID,     CL_PT_BLUE, OFF, lsub(TX_TDMANAGE_HOUR_ID), FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_locked);  
              ...
              beginrow(); // Third row with two columns         
                CreatePromptField     (TDMANAGE_ROW3_ID,     CL_PT_BLUE, OFF, "", FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_locked);
        ...
        // Spacing between columns
          CreatePromptField (TD_SPACE1,    CL_PT_BLUE, OFF,                       "", FT_STANDARD_SIZE, WD_TD_SPACE, HT_MP_DESCRIPTION, No_Margin, widget_locked);          
          
          // Second Column "MONTH"
          beginlayout(LAYOUT_TYPE_GRID, 0);
            beginrow(); // First row with three columns         
              CreatePromptField   (TDMANAGE_MONTH_ID,     CL_PT_BLUE, OFF, lsub(TX_TDMANAGE_MONTH_ID), FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_locked);
            ...
            beginrow(); // Second row with three columns               
              CreatePromptField   (TDMANAGE_MINUTE_ID,     CL_PT_BLUE, OFF, lsub(TX_TDMANAGE_MINUTE_ID), FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_locked);              
            ...
            beginrow(); // Second row with three columns 
              CreatePromptField (TDMANAGE_ROW13_ID,     CL_PT_BLUE, OFF, "", FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_locked);
...
//
        ...
        // Spacing between columns
          CreatePromptField (TD_SPACE2,    CL_PT_BLUE, OFF,                       "", FT_STANDARD_SIZE, WD_TD_SPACE, HT_MP_DESCRIPTION, No_Margin, widget_locked);   
          
          //  Third column "YEAR"
          beginlayout(LAYOUT_TYPE_GRID, 0);
            beginrow(); // First row with three columns       
              CreatePromptField   (TDMANAGE_YEAR_ID,     CL_PT_BLUE, OFF, lsub(TX_TDMANAGE_YEAR_ID), FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_locked); 
            ...
            beginrow(); // Second row with three columns 
              CreatePromptField     (TDMANAGE_ROW22_ID,     CL_PT_BLUE, OFF, "", FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_locked);
              CreateOutputTextField (TDMANAGE_ROW22_INPUT,"", WD_TDBOX_SIZE, HT_TDBOX_SIZE, widget_locked); 
            endrow();

            beginrow(); // Second row with three columns 
              CreatePromptField     (TDMANAGE_ROW23_ID,     CL_PT_BLUE, OFF, "", FT_AUTOPAGE2_SIZE, WD_TDHEADER_SIZE, HT_TDBOX_SIZE, No_Margin, widget_unlocked);
...
endlayout(); 
   ...
   createwidget (0, WIDGET_TYPE_STRETCH);  
   CreateNavigButtons (10, NAV_FCT_BUTTON_1, OFF);
   DrawNavButtons (SCREEN_TDMANAGE, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_SAVE, BTN_NIL_BLUE); 
