...
dbase TX_DBWEIGHPROGRAM WPdb[WPdbSIZE]
{
      ...
      int       SlowFillFactor;
      string    CPSmFastAvgPoints1[2][63];
      string    CPSmSlowAvgPoints1[2][63];
      string    CPSmSlowItpPoints1[8][63];
      float     CPSmSwitchTime1;
      string    CPFlFastPoints1[2][63];
      string    CPFlDeviationPoints1[4][63];
      string    CPSmFastAvgPoints2[2][63];
      string    CPSmSlowAvgPoints2[2][63];
      string    CPSmSlowItpPoints2[8][63];
      float     CPSmSwitchTime2;
      string    CPFlFastPoints2[2][63];
      string    CPFlDeviationPoints2[4][63];
