...
void DisplayHandlingLogic(void)
{
 ...
 int i;
    ...
    if (SystemCleanMem1 != SystemClean1)
     {
      if (Current_Screen == SCREEN_GOTO)
       {
        switch (SystemClean1)
        ...
        SystemCleanMem1 = SystemClean1;
        SystemCleanFct1(SystemClean1);
       }
     }
    else
    if (SystemCleanMem2 != SystemClean2)
     {
      if (Current_Screen == SCREEN_GOTO)
       {
        switch (SystemClean2)
        ...
        SystemCleanMem2 = SystemClean2;
        SystemCleanFct2(SystemClean2);
       }
     }
