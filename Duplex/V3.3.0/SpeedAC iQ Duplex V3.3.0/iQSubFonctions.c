...
/*------------------------------------------------------------------------- 
--  Procedure Name    : SystemCleanFct
--  Created by        : Steve Santerre
--  Last modified on  : 2020/07
--  
--  Purpose           : Active/Deactivate IOs for System Cleanup 
--                      
--  Value Parameters  :
--  Variable Params   : clean or stop cleaning
--  Side Effects      : 
--------------------------------------------------------------------------*/
void SystemCleanFct1(bool Clean)
{
 if(Clean)
  {
    SystemClean1 = ON;
       ...
       Output_ON(O_VibrDischDoor1);
       Output_ON(O_DischDoor1);
       Output_ON(O_DischDoor12);
    
       if(MC.FeederType == FeederGHS)
        {
         aout(AIO1,100.0);
        }
        else
...
void SystemCleanFct2(bool Clean)
{
 if(Clean)
  {
    SystemClean2 = ON;
