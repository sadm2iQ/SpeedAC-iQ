       ...
       // Left display with weighing in-/outputs without infoline
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // Third row with three columns 
              CreatePromptField     (MP_ROW33_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputTextField (MP_ROW33_INPUT,                                      "", WD_MP_BOX, HT_MP_BOX, widget_locked);
