       ...
       // Layout of both recipe columns
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #1
            beginrow(); // First row with three columns 
              CreatePromptField (RECIPE_ROW1_ID,    CL_PT_BLUE, OFF,                       lsub(TX_IDUNDERREJECT), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (RECIPE_ROW1_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 3, OFF, lsub(TX_IDUNDERREJECT), WD_WP_BOX, HT_WP_BOX, widget_locked );
            ...
            beginrow(); // Second row with three columns
              CreatePromptField (RECIPE_ROW2_ID,    CL_PT_BLUE, OFF,                       lsub(TX_IDUNDERACCEPT), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (RECIPE_ROW2_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 3, OFF, lsub(TX_IDUNDERACCEPT), WD_WP_BOX, HT_WP_BOX, widget_locked );
            ...
            beginrow(); // Thirth row with three columns
              CreatePromptField (RECIPE_ROW3_ID,    CL_PT_BLUE, OFF,                       lsub(TX_WPNOMINALWEIGHT), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked ); 
              CreateInputField  (RECIPE_ROW3_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 7, 3, OFF, lsub(TX_WPNOMINALWEIGHT), WD_WP_BOX, HT_WP_BOX, widget_locked );
            ...
            beginrow(); // Fourth row with three columns
              CreatePromptField (RECIPE_ROW4_ID,    CL_PT_BLUE, OFF,                       lsub(TX_IDOVERACCEPT), FT_STANDARD_SIZE, WD_WP_DESCRIPTION,HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (RECIPE_ROW4_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 3, OFF, lsub(TX_IDOVERACCEPT), WD_WP_BOX, HT_WP_BOX, widget_locked );
            ...
            beginrow(); // Fifth row with three columns
              CreatePromptField (RECIPE_ROW5_ID,    CL_PT_BLUE, OFF,                       lsub(TX_IDOVERREJECT), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (RECIPE_ROW5_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 3, OFF, lsub(TX_IDOVERREJECT), WD_WP_BOX, HT_WP_BOX, widget_locked );
            ...
            beginrow(); // Sixth row with three columns
              CreatePromptField(RECIPE_ROW6_ID,     CL_PT_BLUE, OFF,                  lsub(TX_WPTAREWEIGHT), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField (RECIPE_ROW6_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_WPTAREWEIGHT), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField  (RECIPE_ROW6_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         WP.Unit, WD_UNIT, HT_WP_BOX, widget_locked );
            endrow();
        ...
        // Layout of second column of recipe page on the right
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #2
            beginrow(); // First row with three columns 
              CreatePromptField     (RECIPE_ROW7_ID,    CL_PT_BLUE, OFF,                   lsub(TX_WPUNITSELECTION) , FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateComboBoxField   (RECIPE_ROW7_SELECT,FT_STANDARD_SIZE, FT_RTC_BOLD,       lsub(TX_KG), lsub(TX_LB), "", "", "", WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField       (RECIPE_ROW7_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                           "", WD_UNIT_LEFT, HT_WP_BOX, widget_locked);
            endrow();     
            
            beginrow(); // Second row with three columns  
              CreatePromptField (RECIPE_ROW8_ID,    CL_PT_BLUE, OFF,                       lsub(TX_WPBAGLENGTH) , FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (RECIPE_ROW8_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_FLOAT, 5, 2, OFF, lsub(TX_WPBAGLENGTH), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField   (RECIPE_ROW8_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                             "mm", WD_UNIT_LEFT, HT_WP_BOX, widget_locked );
            endrow();    
            
            beginrow(); // Third row with three columns 
              CreatePromptField(RECIPE_ROW9_ID,     CL_PT_BLUE, OFF,                  lsub(TX_WPDYNAMICOFFSET), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField (RECIPE_ROW9_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 3, OFF, lsub(TX_WPDYNAMICOFFSET), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField  (RECIPE_ROW9_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         WP.Unit, WD_UNIT, HT_WP_BOX, widget_locked );
            endrow();                              
          
            beginrow(); // Fourth row with three columns  
              CreatePromptField     (RECIPE_ROW10_ID,    CL_PT_BLUE, OFF,                   lsub(TX_WPREJECTCFG) , FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateComboBoxField   (RECIPE_ROW10_SELECT,FT_STANDARD_SIZE, FT_RTC_BOLD,       lsub(TX_WPBOTH), lsub(TX_WPUNDERWEIGHT), lsub(TX_WPOVERWEIGHT), "", "", WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField       (RECIPE_ROW10_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                           "", WD_UNIT_LEFT, HT_WP_BOX, widget_locked);
            endrow();            

            beginrow(); // Fifth row with three columns 
              CreatePromptField(RECIPE_ROW11_ID,     CL_PT_BLUE, OFF,                  lsub(TX_WPREJECTUNITDELAY), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField (RECIPE_ROW11_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_WPREJECTUNITDELAY), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField  (RECIPE_ROW11_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         TX_SEC_UNIT, WD_UNIT, HT_WP_BOX, widget_locked );
            endrow();  

            beginrow(); // Sixth row with three columns
              CreatePromptField(RECIPE_ROW12_ID,     CL_PT_BLUE, OFF,                  lsub(TX_WPREJECTUNITTIME), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField (RECIPE_ROW12_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_WPREJECTUNITTIME), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField  (RECIPE_ROW12_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         TX_SEC_UNIT, WD_UNIT, HT_WP_BOX, widget_locked );
            endrow(); 
...
void CreateRecipePage2(void) 
{
  ...
  beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #1
      ...
      beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #3  
       ...
       // Layout of both recipe columns
        beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); 
            beginrow(); // First row (Operator) with three columns 
              CreatePromptField     (RECIPE_ROW13_ID,    CL_PT_BLUE, OFF,                   lsub(TX_WPT1) , FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField      (RECIPE_ROW13_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 3, OFF, lsub(TX_WPT1), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField       (RECIPE_ROW13_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                        lsub(TX_SEC_UNIT), WD_UNIT, HT_WP_BOX, widget_locked );
            endrow();
            
            beginrow(); // Second row (Article no) with three columns
              CreatePromptField     (RECIPE_ROW14_ID,    CL_PT_BLUE, OFF,                   lsub(TX_WPT2) , FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField      (RECIPE_ROW14_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 3, OFF, lsub(TX_WPT2), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField       (RECIPE_ROW14_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         lsub(TX_SEC_UNIT), WD_UNIT, HT_WP_BOX, widget_locked );
            endrow();
            
            beginrow(); // Thirth row (Article no) with three columns
              CreatePromptField (RECIPE_ROW15_ID,    CL_PT_BLUE, OFF,                       lsub(TX_FLEXCOUNTER), FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (RECIPE_ROW15_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 6, 0, OFF, lsub(TX_FLEXCOUNTER), WD_WP_BOX, HT_WP_BOX, widget_locked );
            ...
            beginrow(); // Fourth row (Article no) with three columns
              CreatePromptField (RECIPE_ROW16_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateOutputTextField (RECIPE_ROW16_INPUT,                                      "", WD_WP_BOX, HT_WP_BOX, widget_locked);
            ...
            beginrow(); // Fifth row (Article no) with three columns
              CreatePromptField   (RECIPE_ROW17_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateOutputTextField (RECIPE_ROW17_INPUT,                                      "", WD_WP_BOX, HT_WP_BOX, widget_locked);
            ...
            beginrow(); // Sixth row (Article no) with three columns
              CreatePromptField     (RECIPE_ROW18_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, Left_Margin, widget_locked);
              CreateOutputTextField (RECIPE_ROW18_INPUT,                                      "", WD_WP_BOX, HT_WP_BOX, widget_locked);
        ...
        // LAyout of second column of recipe page on the right  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            beginrow(); // First row (Operator) with three columns 
              CreatePromptField     (RECIPE_ROW19_ID,    CL_PT_BLUE, OFF,                   lsub(TX_WPSP1) , FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField      (RECIPE_ROW19_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 3, OFF, lsub(TX_WPSP1), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField       (RECIPE_ROW19_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         WP.Unit, WD_UNIT_LEFT, HT_WP_BOX, widget_locked );
            endrow();     
            
            beginrow(); // Second row (Operator) with three columns  
              CreatePromptField     (RECIPE_ROW20_ID,    CL_PT_BLUE, OFF,                   lsub(TX_WPSP2) , FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField      (RECIPE_ROW20_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 3, OFF, lsub(TX_WPSP2), WD_WP_BOX, HT_WP_BOX, widget_locked );
              CreateUnitField       (RECIPE_ROW20_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         WP.Unit, WD_UNIT_LEFT, HT_WP_BOX, widget_locked );
            endrow();    
            
            beginrow(); // Third row with three columns  
              CreatePromptField     (RECIPE_ROW21_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputTextField (RECIPE_ROW21_INPUT,                                      "", WD_WP_BOX, HT_WP_BOX, widget_locked);
              CreateUnitField       (RECIPE_ROW21_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         "", WD_UNIT_LEFT, HT_WP_BOX, widget_locked );
            endrow();    
            
            beginrow(); //  Fourth row with three columns 
              CreatePromptField     (RECIPE_ROW22_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputTextField (RECIPE_ROW22_INPUT,                                      "", WD_WP_BOX, HT_WP_BOX, widget_locked);
            ...
            beginrow(); // Fifth row (Operator) with three columns 
              CreatePromptField     (RECIPE_ROW23_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputTextField (RECIPE_ROW23_INPUT,                                      "", WD_WP_BOX, HT_WP_BOX, widget_locked);
              CreateUnitField       (RECIPE_ROW23_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,                         "", WD_UNIT_LEFT, HT_WP_BOX, widget_locked );
            endrow();  

            beginrow(); // Sixth row (Article no) with three columns
              CreatePromptField     (RECIPE_ROW24_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_WP_DESCRIPTION, HT_WP_DESCRIPTION, No_Margin, widget_locked);
              CreateOutputTextField (RECIPE_ROW24_INPUT,                                      "", WD_WP_BOX, HT_WP_BOX, widget_locked);
   ...
   CreateNavigButtons (10, NAV_FCT_BUTTON_1, OFF);
   DrawNavButtons (SCREEN_RECIPE2, ON, BTN_AUTO, BTN_RECIPE, BTN_REPORT, BTN_NAVIG, BTN_ALARM, BTN_NIL_BLUE, BTN_PREV, BTN_NIL_BLUE, BTN_NIL_BLUE, BTN_NIL_BLUE);     
...
void RefreshWPScreen(int Scrn_No)
{
 ...
 if (Scrn_No==SCREEN_RECIPE1 || Scrn_No==SCREEN_RECIPE2 ) 
 {
   begindraw(); 
    ...
    switch ( Scrn_No )
    {
      case SCREEN_RECIPE1 : 
                      ...
                      widget_text (RECIPE_SEARCH_ID, concat(space(1),lsub(WP.Name),space(RECIPECHARSPACE), "1" , space(1), TX_FSLASH, space(1),"2", space(1)));
                         
                    // First Column                                
                      
                      widget_text      (RECIPE_ROW1_INPUT,  WP.TolUnderRejWeight);
                      widget_text      (RECIPE_ROW1_UNIT,   WP.Unit);
                      
                      widget_text      (RECIPE_ROW2_INPUT,  WP.TolUnderAccWeight);
                      widget_text      (RECIPE_ROW2_UNIT,   WP.Unit);
                    
                      widget_text      (RECIPE_ROW3_INPUT,  WP.NominalWeight);
                      widget_text      (RECIPE_ROW3_UNIT,   WP.Unit);
                      
                      widget_text      (RECIPE_ROW4_INPUT,  WP.TolOverAccWeight);
                      widget_text      (RECIPE_ROW4_UNIT,   WP.Unit);
                      
                      widget_text      (RECIPE_ROW5_INPUT,  WP.TolOverRejWeight);
                      widget_text      (RECIPE_ROW5_UNIT,   WP.Unit);
                      
                      widget_text      (RECIPE_ROW6_INPUT,  WP.TareWeight);
                      widget_text      (RECIPE_ROW6_UNIT,   WP.Unit);
    
                    // Second Column 
                      widget_set_index (RECIPE_ROW7_SELECT, (WP.Unit==TX_LB),0);
                     
                      if(!MC.System)
                      {
                       widget_format(RECIPE_ROW8_INPUT,INPUT_FORMAT_DECIMAL,4,0); //Bag Lenght
                       widget_text  (RECIPE_ROW8_INPUT,adj(WP.BagLength,4,0));
                      }
                      else
                      {  
                       widget_format(RECIPE_ROW8_INPUT,INPUT_FORMAT_DECIMAL,5,2); //Bag Lenght
                       widget_text  (RECIPE_ROW8_INPUT,adj(WP.BagLength,5,2));
                      }
                      
                      widget_text(RECIPE_ROW8_UNIT,LengthText);
                    
                      widget_text      (RECIPE_ROW9_INPUT,  WP.DynamicOffset);
                      widget_text      (RECIPE_ROW9_UNIT,   WP.Unit);
                      
                      widget_set_index (RECIPE_ROW10_SELECT, WP.RejectCfg,0);
                      
                      widget_text      (RECIPE_ROW11_INPUT,  WP.RejectUnitDelay);
                      widget_text      (RECIPE_ROW12_INPUT,  WP.RejectUnitTime);
      ...
      case SCREEN_RECIPE2 :
                      ...
                      widget_text (RECIPE_SEARCH_ID, concat(space(1),lsub(WP.Name),space(RECIPECHARSPACE), "2" , space(1), TX_FSLASH, space(1),"2", space(1)));
      
                     // First Column 
                      
                      widget_text      (RECIPE_ROW13_INPUT,  WP.FlexT1);
                      widget_text      (RECIPE_ROW14_INPUT,  WP.FlexT2);
                      widget_text      (RECIPE_ROW15_INPUT,  WP.FlexCounter);
                      
                    // Second Column
                      widget_text      (RECIPE_ROW19_INPUT,  WP.FlexSP1);
                      widget_text      (RECIPE_ROW19_UNIT,   WP.Unit);
                      
                      widget_text      (RECIPE_ROW20_INPUT,  WP.FlexSP2);
                      widget_text      (RECIPE_ROW20_UNIT,   WP.Unit);
...
/*------------------------------------------------------------------------- 
--  Procedure Name    : WPLimitCheck
--  Created by        : Steve Santerre
--  Last modified on  : 2020/03
--  
--  Purpose           : Check and correct Limit values of WP 
--                      in respect to Division and Nominal value
--  Value Parameters  :
--  Variable Params   : 
                      :  
--  Side Effects      : 
--------------------------------------------------------------------------*/
void WPLimitCheck(void)
{
  
  if(WP.NominalWeight > Div*2)
  {
   WP.NominalWeight = int(WP.NominalWeight/Div) * Div;
   
   WP.TolUnderRejWeight = LimRound(0,WP.NominalWeight-(Div*2),WP.TolUnderRejWeight,Div);
  
   WP.TolUnderAccWeight = LimRound(WP.TolUnderRejWeight+Div,WP.NominalWeight-Div,WP.TolUnderAccWeight,Div);
  
   WP.TolOverRejWeight =  LimRound(WP.NominalWeight+(Div*2),MaxWeight,WP.TolOverRejWeight,Div);
  
   WP.TolOverAccWeight =  LimRound(WP.NominalWeight+Div,WP.TolOverRejWeight-Div,WP.TolOverAccWeight,Div);
  } 
...
decimal NominalWeightPrev%6.2,NominalWeightOffset%6.2;
 begindraw();
  switch (Scrn_No)
  {
    case SCREEN_RECIPE1 :
                      ...
                      {      
                        ...
                        case RECIPE_ROW1_INPUT :  WP.TolUnderRejWeight = LimRound(0,WP.TolUnderAccWeight,Argument,Div);
                                                  WPLimitCheck(); 
                                                  break;  
                        
                        case RECIPE_ROW2_INPUT :  WP.TolUnderAccWeight = LimRound(WP.TolUnderRejWeight,WP.NominalWeight,Argument,Div);
                                                  WPLimitCheck();
                                                  break;
                                                        
                        case RECIPE_ROW3_INPUT :  NominalWeightPrev =  WP.NominalWeight;
                                                  WP.NominalWeight = decimal (LimRound(MaxWeight*0.05,MaxWeight*0.9,Argument,Div));
                                                  NominalWeightOffset =  NominalWeightPrev - WP.NominalWeight;
                                                                                                    
                                                //Autotracking feature 
                                                  WP.TolUnderAccWeight = WP.TolUnderAccWeight-NominalWeightOffset;
                                                  WP.TolUnderRejWeight = WP.TolUnderRejWeight-NominalWeightOffset;
                                                  WP.TolOverAccWeight =  WP.TolOverAccWeight-NominalWeightOffset;
                                                  WP.TolOverRejWeight =  WP.TolOverRejWeight-NominalWeightOffset;
                                                  WPLimitCheck();
                                                  break;
                        
                        case RECIPE_ROW4_INPUT :  WP.TolOverAccWeight = LimRound(WP.NominalWeight,WP.TolOverRejWeight,Argument,Div);
                                                  WPLimitCheck();
                                                  break; 
                                                       
                        case RECIPE_ROW5_INPUT :  WP.TolOverRejWeight = LimRound(WP.TolOverAccWeight,MaxWeight,Argument,Div);
                                                  WPLimitCheck();
                                                  break;
                        
                        case RECIPE_ROW6_INPUT :  WP.TareWeight = LimRound(0,9.99,Argument,Div);
                                                  break;                                                  
                        
                        case RECIPE_ROW8_INPUT :  WP.BagLength = Lim(1,9999,Argument);
                                                  break;  
                        case RECIPE_ROW9_INPUT :  WP.DynamicOffset = Lim(-9.999,9.999,Argument);
                                                  break;
                        case RECIPE_ROW11_INPUT :  WP.RejectUnitDelay = Lim(0,9.99,Argument);
                                                  break;
                        case RECIPE_ROW12_INPUT :  WP.RejectUnitTime =  Lim(0,9.99,Argument);
                                                  break;                                                                                    
     ...
     case SCREEN_RECIPE2 :
                     ...
                     {                    
                        ...
                        case RECIPE_ROW13_INPUT : WP.FlexT1 = Lim(0,60,Argument);
                                                  FlexIO_SetTPresetsFlag = Execute;
                                                  break; 
                                                  
                        case RECIPE_ROW14_INPUT : WP.FlexT2 = Lim(0,60,Argument);
                                                  FlexIO_SetTPresetsFlag = Execute;
                                                  break;
                                                  
                        case RECIPE_ROW15_INPUT : WP.FlexCounter = Lim(0,999999,Argument);
                                                  FlexIO_SetTPresetsFlag = Execute;
                                                  break;                          
                        
                        case RECIPE_ROW19_INPUT : WP.FlexSP1 = Lim(0,WP.NominalWeight,Argument);
                                                  FlexIO_SetTPresetsFlag = Execute;
                                                  break; 
                                                  
                        case RECIPE_ROW20_INPUT : WP.FlexSP2 = Lim(0,WP.NominalWeight,Argument);
                                                  FlexIO_SetTPresetsFlag = Execute;
                                                  break;
                     } 
                   break;                                                                                                                                                                        
 ...
 begindraw();
  ...
  {  
    case SCREEN_RECIPE1 :
                  switch (value)
                   {
                     case RECIPE_ROW7_SELECT :  WP.Unit       = Arg_str;
                                                 break;
                     case RECIPE_ROW10_SELECT :  WP.RejectCfg = Arg_int;
                                                 break;                            
                   }
