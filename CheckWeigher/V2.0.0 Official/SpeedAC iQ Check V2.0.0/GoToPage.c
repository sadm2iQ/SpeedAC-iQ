    ...
    beginlayout(LAYOUT_TYPE_VBOX, 0); //VBOX #1
        ...
        /* ***************************** */
         ...
         beginlayout(LAYOUT_TYPE_HBOX, 0); //Buttons
          ...
          DrawGenericButtons (SCREEN_GOTO, ON, 10, GOTO_FCT_BUTTON_1, BTN_NIL_WHITE, BTN_CHKWGT, BTN_NIL_WHITE, BTN_AUTOTUNEDONE, 
                                                                    BTN_NIL_WHITE, BTN_LANGUAGE, BTN_NIL_WHITE, BTN_LOAD_DBS, BTN_NIL_WHITE, BTN_NIL_WHITE );                                                      
         endlayout(); // Buttons 
