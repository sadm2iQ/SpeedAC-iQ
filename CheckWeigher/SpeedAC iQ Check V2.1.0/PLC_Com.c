...
/* Read commands from PLC*/
  ...
  #define b_SCL_ProdDataReady          5 
  #define b_SCL_Handshake              6 
  #define b_SCL_SwapDWBits             7
  #define b_SCL_BatchEnded             8
  #define b_SCL_WeightChecked          9
  #define b_SCL_BypassCheck            10
...
enum //Value # for Set Action(Parameter = 31)
{
No_Operation = 0, 
Reset_ProdReport = 20, 
...
int Tempo, err;
  ...
  switch (IN_Value)
  {
   ...
   case Bypass_Check:  
                              if(!AutoMode)
                               {
                                CheckWeightHMI = ON;     //Bypass Check mode   
                                Tempo = Bypass_Check;
                               }
                              else
                                Tempo = Bypass_Check + InvalidNbr; 
       break;    
...
void Display_AdditionalLiveInfo(void)
{
  int DW_Pointer; 
     ...
     DW_Pointer = 1;
     return_value[DW_Pointer] = WP.NominalWeight;          //16
     DW_Pointer++;
     return_value[DW_Pointer] = ProdAvgWeight;             //18
     DW_Pointer++;
     return_value[DW_Pointer] = ProdStdDev;                //20
     DW_Pointer++;
     return_value[DW_Pointer] = ProdLastChecked;           //22
     DW_Pointer++;
     return_value[DW_Pointer] = ProdCycleUnitsPerMin;      //24
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolTotalCnt;            //26
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TotalWeight;            //28
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolUnderRejCnt;         //30
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolUnderAccCnt;         //32
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolGoodCnt;             //34
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolOverAccCnt;          //36
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolOverRejCnt;          //38
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolInvalidCnt;          //40
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.Preset;              //42
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.Count;               //44
     DW_Pointer++;
     return_value[DW_Pointer] = Batch_TotalWeight;         //46
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolUnderRejCnt;      //48
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolUnderAccCnt;      //50
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolGoodCnt;          //52
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolOverAccCnt;       //54
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolOverRejCnt;       //56
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolInvalidCnt;       //58
     DW_Pointer++;
     return_value[DW_Pointer] = ProdTotalUnitsLT;          //60
     DW_Pointer++;
     ProdTotalWeightLT = ProdTotalWeightLTkg / WP_UnitToKG;
     return_value[DW_Pointer] = ProdTotalWeightLT;         //62
}
...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = Read_Auto_Page;//32     //14
     DW_Pointer++;
     return_value[DW_Pointer] = WP.No;                  //16                    
     DW_Pointer++;                                     
     return_value[DW_Pointer] = WP.NominalWeight;       //18                     
     DW_Pointer++;
     return_value[DW_Pointer] = ProdAvgWeight;          //20
     DW_Pointer++;
     return_value[DW_Pointer] = ProdStdDev;             //22
     DW_Pointer++;
     return_value[DW_Pointer] = ProdLastChecked;        //24 
     DW_Pointer++; 
     return_value[DW_Pointer] = ProdCycleUnitsPerMin;   //26
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolTotalCnt;         //28
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.Count;            //30
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.Preset;           //32
     DW_Pointer++;                       
     return_value[DW_Pointer] = TolUnderRejCntTemp;      //34
     DW_Pointer++;
     return_value[DW_Pointer] = TolUnderAccCntTemp;      //36
     DW_Pointer++;
     return_value[DW_Pointer] = TolGoodCntTemp;          //38
     DW_Pointer++;
     return_value[DW_Pointer] = TolOverAccCntTemp;       //40
     DW_Pointer++;
     return_value[DW_Pointer] = TolOverRejCntTemp;       //42
     DW_Pointer++;
     return_value[DW_Pointer] = TolInvalidCntTemp;       //44
}
...
int DW_Pointer; 
     ...
     DW_Pointer = 0;
     return_value[DW_Pointer] = Read_Report_Page; //40     //14                 
     DW_Pointer++;
     return_value[DW_Pointer] = WP.NominalWeight;          //16
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolTotalCnt;            //18
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TotalWeight;            //20
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolUnderRejCnt;         //22
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolUnderAccCnt;         //24
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolGoodCnt;             //26
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolOverAccCnt;          //28
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolOverRejCnt;          //30
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolInvalidCnt;          //32
     DW_Pointer++;
     return_value[DW_Pointer] = ProdTotalUnitsLT;          //34
     DW_Pointer++;
     ProdTotalWeightLT = ProdTotalWeightLTkg / WP_UnitToKG;
     return_value[DW_Pointer] = ProdTotalWeightLT;         //36
}
...
int DW_Pointer; 
     ...
     DW_Pointer = 0;
     return_value[DW_Pointer] = Read_Batch_Page; //50     //14                  
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.Preset;             //16
     DW_Pointer++;
     return_value[DW_Pointer] = WP.NominalWeight;         //18                     
     DW_Pointer++;                                      
     return_value[DW_Pointer] = Batch.Avg;                //20
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.StdDev;             //22    
     DW_Pointer++; 
     return_value[DW_Pointer] = Batch_TotalWeight;         //24
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolUnderRejCnt;      //26
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolUnderAccCnt;      //28
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolGoodCnt;          //30
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolOverAccCnt;       //32
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolOverRejCnt;       //34
     DW_Pointer++;
     return_value[DW_Pointer] = Batch.TolInvalidCnt;       //36
     DW_Pointer++;
...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = Read_WP_Page1; //61     //14                   
     DW_Pointer++; 
     return_value[DW_Pointer] = WP.TolUnderRejWeight;   //16
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolUnderAccWeight;   //18
     DW_Pointer++;
     return_value[DW_Pointer] = WP.NominalWeight;       //20
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolOverAccWeight;    //22
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TolOverRejWeight;    //24
     DW_Pointer++;
     return_value[DW_Pointer] = WP.TareWeight;          //26
     DW_Pointer++;  
     return_value[DW_Pointer] = WP.Unit==TX_LB;         //28
     DW_Pointer++;
     return_value[DW_Pointer] = WP.BagLength;           //30
     DW_Pointer++;
     return_value[DW_Pointer] = WP.DynamicOffset;       //32
     DW_Pointer++;  
     return_value[DW_Pointer] = WP.RejectCfg;           //34
     DW_Pointer++; 
     return_value[DW_Pointer] = WP.RejectUnitDelay;     //36
     DW_Pointer++;
     return_value[DW_Pointer] = WP.RejectUnitTime;      //38
...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = Read_WP_Page2; //62   //14
     DW_Pointer++;
     return_value[DW_Pointer] = WP.FlexT1;            //16
     DW_Pointer++;
     return_value[DW_Pointer] = WP.FlexT2;            //18
     DW_Pointer++;
     return_value[DW_Pointer] = WP.FlexCounter;       //20
     DW_Pointer++;
     return_value[DW_Pointer] = WP.FlexSP1;           //22
     DW_Pointer++;
     return_value[DW_Pointer] = WP.FlexSP2;           //24 
}
...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = Read_MC_Page1; //71   //14
     DW_Pointer++; 
     return_value[DW_Pointer] = MC.PortCOM2Cfg;       //16
     DW_Pointer++;                                    
     return_value[DW_Pointer] = MC.PortUSBCfg;        //18
     DW_Pointer++;
     return_value[DW_Pointer] = MC.PortETHCfg;        //20
     DW_Pointer++;
     return_value[DW_Pointer] = MC.NumberOfWP;        //22
     DW_Pointer++; 
     return_value[DW_Pointer] = MC.OIML;              //24
     DW_Pointer++;
     return_value[DW_Pointer] = MC.Language2;         //26
     DW_Pointer++;
     return_value[DW_Pointer] = MC.Language3;         //28
...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = Read_MC_Page2; //72    //14                     
     DW_Pointer++; 
     
     return_value[DW_Pointer] = Access_PW[0];          //16     PWD OP                
     DW_Pointer++;                                    
     return_value[DW_Pointer] = Access_PW[1];          //18     PWD SUP
     DW_Pointer++;
     return_value[DW_Pointer] = Access_Timeout[0];     //20     Log Out Delay OP
     DW_Pointer++;
     return_value[DW_Pointer] = Access_Timeout[1];     //22     Log Out Delay SUP
     DW_Pointer++;
     return_value[DW_Pointer] = Access_Timeout[2];     //24     Log Out Delay PT
     DW_Pointer++;
     return_value[DW_Pointer] = MC.System;             //26  
     DW_Pointer++;
     return_value[DW_Pointer] = MC.Mouse;              //28     
...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = Read_MP_Page1; //81     //14                    
     DW_Pointer++;
     return_value[DW_Pointer] = MP.PCEntryTimeout;      //16                   
     DW_Pointer++;
     return_value[DW_Pointer] = MP.PCExitTimeout;       //18                        
     DW_Pointer++;
     return_value[DW_Pointer] = MP.AutoTuneCfg;         //20                        
     DW_Pointer++;
     return_value[DW_Pointer] = MP.ScreenSaverTime;     //22                        
     DW_Pointer++;
     return_value[DW_Pointer] = MP.PhotocellsDistance;  //24 
     DW_Pointer++;
     return_value[DW_Pointer] = MP.BeltSpeed;           //26                         
...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = Read_MP_Page2; //82   //14                      
     DW_Pointer++;
     return_value[DW_Pointer] = MP.FlexT1;            //16
     DW_Pointer++;
     return_value[DW_Pointer] = MP.FlexT2;            //18
     DW_Pointer++;
     return_value[DW_Pointer] = MP.FlexCounter;       //20
     DW_Pointer++;
     return_value[DW_Pointer] = MP.FlexSP1;           //22
     DW_Pointer++;
     return_value[DW_Pointer] = MP.FlexSP2;           //24
}
...
int Scale_Status (void)
{
  ...
  if ( ScaleStatus==66 )    setbit(b_SCL_Service_Mode,  dw[OUT_PLC_ScaleStatus]); else clrbit(b_SCL_Service_Mode,    dw[OUT_PLC_ScaleStatus]);
  if ( ScaleStatus==12 )    setbit(b_SCL_Overload,      dw[OUT_PLC_ScaleStatus]); else clrbit(b_SCL_Overload,        dw[OUT_PLC_ScaleStatus]);
  if ( !IsSettled      )    setbit(b_SCL_Motion,        dw[OUT_PLC_ScaleStatus]); else clrbit(b_SCL_Motion,          dw[OUT_PLC_ScaleStatus]);
  if ( ScaleStatus!=0 )     setbit(b_SCL_Scale_Error,   dw[OUT_PLC_ScaleStatus]); else clrbit(b_SCL_Scale_Error,     dw[OUT_PLC_ScaleStatus]);
  ...
  if ( UnitChecked)         setbit(b_SCL_WeightChecked, dw[OUT_PLC_ScaleStatus]); else clrbit(b_SCL_WeightChecked,   dw[OUT_PLC_ScaleStatus]);
  if (!CheckAll)            setbit(b_SCL_BypassCheck,   dw[OUT_PLC_ScaleStatus]); else clrbit(b_SCL_BypassCheck,     dw[OUT_PLC_ScaleStatus]);
...
int i;
 ...
 if (Swap)//(FB_EthernetIP) /* AB Ethernet IP Swap Bits ABCD-->CDAB */
 {
   ...
   dw[OUT_PLC_WP]                = Swap_DW_Bits_Output(OUT_WP);    
...
int i, j=0, err, DW_Pointer;
               ...
               if(IN_ValueMem == IN_Value && IN_CommandMem == IN_Command && IN_ParameterMem == IN_Parameter)
                ...
                {             
                         switch (IN_Parameter)
                         {
                          ...
                          case Batch_Preset:
                           if((SeqModeManager == stp_OFF_MODE || BatchEnded) && (IN_Value >=0 || IN_Value <999999))
                            {
                             Batch.Preset = IN_Value;
                             return_value[0] = Batch_Preset; 
                            }
                           else
                            return_value[0] = Batch_Preset + InvalidNbr;    
      ...
      case DW_Read:
                        ...
                        switch (IN_Parameter)
                        {
                           ...
                           case Read_WPNameList:
                                                  if(IN_Value > 0 && IN_Value <= MC.NumberOfWP)
                                                  {
                                                   Display_String(wpNameList[int(IN_Value)]);
                                                   return_value[31] = IN_Value;
                                                  }
                                                  else
                                                   return_value[31] = IN_Value + InvalidNbr;
                                break;
    ...
    OUT_LiveWeight_MSB  = Convert_Single2Double(NetWeight, HighBit);
    OUT_LiveWeight_LSB  = Convert_Single2Double(NetWeight, LowBit);
