...
{
int     i=0,j, Index_No[IO_IN_MAX]=0, result ,ID_GENERIC_DBASE_LIST;
  ...
  switch ( Scrn_No )
  {
    case SCREEN_FLEXIO_1 :  
                  ...
                  // Output 1 ON                                
                    ...
                    if ((FlexIO_Type[Flex_Out1][FlexOutput_ON]==Flex_Input && FlexIO_IOEnum[Flex_Out1][FlexOutput_ON] < IO_OUT_MIN ) || (FlexIO_Type[Flex_Out1][FlexOutput_ON]==Flex_Output && FlexIO_IOEnum[Flex_Out1][FlexOutput_ON] >= IO_OUT_MIN ))
                    {
                  ...
                  // Output 1 OFF
                    ...
                    if ((FlexIO_Type[Flex_Out1][FlexOutput_OFF]==Flex_Input && FlexIO_IOEnum[Flex_Out1][FlexOutput_OFF] < IO_OUT_MIN ) || (FlexIO_Type[Flex_Out1][FlexOutput_OFF]==Flex_Output && FlexIO_IOEnum[Flex_Out1][FlexOutput_OFF] >= IO_OUT_MIN ))
                    {                      
    ...
    case SCREEN_FLEXIO_2 :    
                  ...
                  // Output 2 ON                                
                    ...
                    if ((FlexIO_Type[Flex_Out2][FlexOutput_ON]==Flex_Input && FlexIO_IOEnum[Flex_Out2][FlexOutput_ON] < IO_OUT_MIN ) || (FlexIO_Type[Flex_Out2][FlexOutput_ON]==Flex_Output && FlexIO_IOEnum[Flex_Out2][FlexOutput_ON] >= IO_OUT_MIN ))
                    {
                 ...
                 // Output 2 OFF
                    ...
                    if ((FlexIO_Type[Flex_Out2][FlexOutput_OFF]==Flex_Input && FlexIO_IOEnum[Flex_Out2][FlexOutput_OFF] < IO_OUT_MIN ) || (FlexIO_Type[Flex_Out2][FlexOutput_OFF]==Flex_Output && FlexIO_IOEnum[Flex_Out2][FlexOutput_OFF] >= IO_OUT_MIN ))
                    {
    ...
    case SCREEN_FLEXIO_3 :    
                  ...
                  // Output 3 ON                                
                    ...
                    if ((FlexIO_Type[Flex_Out3][FlexOutput_ON]==Flex_Input && FlexIO_IOEnum[Flex_Out3][FlexOutput_ON] < IO_OUT_MIN ) || (FlexIO_Type[Flex_Out3][FlexOutput_ON]==Flex_Output && FlexIO_IOEnum[Flex_Out3][FlexOutput_ON] >= IO_OUT_MIN ))
                    {
...
bool Flex_SetpointTest (int i, int j)
{
  ...
  {
    if (NetWeight >= FlexIO_SP_Pre[i][j])
    {
    FlexIO_TestOnFlag[i][j] = ON;
    return (ON);
    }
    else if (NetWeight < FlexIO_SP_Pre[i][j] && FlexIO_SetOnFlag[i][j]) 
...
{
int i,j,k=0,l; 
bool output_status,Test_IO = OFF, Test_SP = OFF,
     return_SP, valid = OFF; 
j = 0;
...
{
int i,j,k=0,l; 
bool output_status,Test_SP = OFF, Test_Pulsing = OFF, Test_IO,
     return_SP, valid = OFF; 
