...
#define BTN_LOGO_PTC            concat(DIRECTORY, "LOGO_WE_CARE.png")
...
#define BTN_ANALOG              concat(DIRECTORY, "BTN_ANALOG.png")
...
#define TOL_UNDER_ACC           concat(DIRECTORY, "TolUnderAccept.png")
#define TOL_UNDER_REJ           concat(DIRECTORY, "TolUnderReject.png")
#define TOL_OVER_ACC            concat(DIRECTORY, "TolOverAccept.png")
#define TOL_OVER_REJ            concat(DIRECTORY, "TolOverReject.png")
#define TOL_GOOD                concat(DIRECTORY, "TolGood.png")
#define TOL_INVALID             concat(DIRECTORY, "TolInvalid.png")

#define TOL_UNDER_ACC_ON           concat(DIRECTORY, "TolUnderAcceptON.png")
#define TOL_UNDER_REJ_ON           concat(DIRECTORY, "TolUnderRejectON.png")
#define TOL_OVER_ACC_ON            concat(DIRECTORY, "TolOverAcceptON.png")
#define TOL_OVER_REJ_ON            concat(DIRECTORY, "TolOverRejectON.png")
#define TOL_GOOD_ON                concat(DIRECTORY, "TolGoodON.png")
#define TOL_INVALID_ON             concat(DIRECTORY, "TolInvalidON.png")
