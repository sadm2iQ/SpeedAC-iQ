...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = ProdTotalWeight;
     DW_Pointer++;
...
int DW_Pointer; 
     ...
     return_value[DW_Pointer] = Batch_TotalWeight;//26
     DW_Pointer++;
