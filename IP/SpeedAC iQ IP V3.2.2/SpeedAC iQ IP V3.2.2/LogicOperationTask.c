...
void Status_Refresh(void)
{
 ...
 if(T_Dn(T_FirstScan))
 {
  ...
  if(WP.NominalWeight != NominalWeightMem || WP.Overfill != OverfillMem || CutoffTempMem != CutoffTemp)//commented by namk 21/9/2018
   {
...
bool FirstChecked;
  ...
  */
  ...
  if(!FirstChecked)
  {
    ...
    if(LastShiftTotalWeightLT == 0) LastShiftTotalWeightLT = ProdTotalWeightLT;
    if(LastShiftTotalUnitsLT == 0) LastShiftTotalUnitsLT = ProdTotalUnitsLT[Scale1];
    if(LastHourlyTotalWeightLT == 0)LastHourlyTotalWeightLT = ProdTotalWeightLT;
  ...
  {   
    ProdTotalWeightOfShift = ProdTotalWeightLT- LastShiftTotalWeightLT;
    ProdTotalUnitOfShift = ProdTotalUnitsLT[Scale1]- LastShiftTotalUnitsLT;
    LastShiftTotalWeightLT = ProdTotalWeightLT;
  ...
  {
    ProdTotalWeightOfHourly = ProdTotalWeightLT- LastHourlyTotalWeightLT;
    ProdTotalUnitOfHourly = ProdTotalUnitsLT[Scale1] - LastHourlyTotalUnitsLT; 
    CurrentShiftUsageWeight = ProdTotalWeightOfShift+(ProdTotalWeightLT - ProdTotalWeightOfShift);
    LastHourlyTotalWeightLT = ProdTotalWeightLT;
