...
void SaveProdVars(void)
{
 ...
 for(i=0;i<=1;i++)
 {
  ...
  ProdTotalWeightNOV[i]      = ProdTotalWeight;  //SADM2 2020 NOVEMBER
  ...
  ProdTotalWeightLTNOV[i]    = ProdTotalWeightLT;  //SADM2 2020 NOVEMBER 
  }
...
void LoadProdVars(void)
{
 ...
 for(i=0;i<=1;i++)
 {
  ...
  ProdTotalWeight         = ProdTotalWeightNOV[i];  //SADM2 2020 NOVEMBER
  ...
  ProdTotalWeightLT    = ProdTotalWeightLTNOV[i];  //SADM2 2020 NOVEMBER
  }  
  //In process related data
  for(j = 0; j < 52; j++)
  {
...
void ResetData(bool OnlyAvgAndStdDev)
{
  ...
  if(!OnlyAvgAndStdDev)
  {
   ...
   BatchReset = ON; //SADM2 2020 November
  } 
...
ProdTotalWeightLT     = 0;  //SADM2 2020 NOVEMBER
...
void ResetBatch(void)
{
 ...
 Batch.StdDev          = 0;
 Batch.Avg             = 0;
 Batch_TotalWeight     = 0; //SADM2 2020 NOVEMBER
 ...
 NumOfRemainUnit = 0;//added by namk
 }
...
void LoadBatch(int Nbr)
{
 ...
 Batch_TotalWeight    = double(Batch.TotalWeight); //SADM2 2020 NOVEMBER
   ...
   if(WPdb.ProdTotalUnitsCnt[Scale1] >= (WPdb.ProdUnderWeightCnt[Scale1]  + WPdb.ProdOverWeightCnt[Scale1]))
    {
     ...
     WP.ProdTotalWeight_1     = WPdb.ProdTotalWeight;  //SADM2 2020 NOVEMBER 
   ...
   else
    {
     ...
     WPdb.ProdTotalWeight      = 0;  //SADM2 2020 NOVEMBER
     SaveWPFlag = Execute;
    }   
...
/* "Need logic to skip the writing of the following if err = 1 or 2"*/
   ...
   WPdb.ProdTotalWeight     = WP.ProdTotalWeight_1;  //SADM2 2020 NOVEMBER
   WPdb.ProdTotalWeight     = WP.ProdTotalWeight_2;  //SADM2 2020 NOVEMBER
   //Remain from Net
...
void PreSave_Data (int WP_No,bool reset)
{
  ...
  WP.ProdTotalWeight_1     = ProdTotalWeight;  //SADM2 2020 NOVEMBER
  WP.ProdTotalWeight_2     = ProdTotalWeight;  //SADM2 2020 NOVEMBER
  SaveWP2Db();
  if(reset)
   {
    ResetData(OFF);
...
{  
  ...
  ProdTotalWeight     = WP.ProdTotalWeight_1;  //SADM2 2020 NOVEMBER
  ProdTotalWeight     = WP.ProdTotalWeight_2;  //SADM2 2020 NOVEMBER
