...
void Display_AdditionalLiveInfo(void)
{
  int DW_Pointer; 
     ...
     DW_Pointer++;
     return_value[DW_Pointer] = ProdTotalWeight;              //42  //SADM2 2020 NOVEMBER
     DW_Pointer++; 
     return_value[DW_Pointer] = ProdTotalWeighmentsLT[Scale1]; //44
     DW_Pointer++;
     return_value[DW_Pointer] = ProdTotalUnitsLT[Scale1];      //46
     DW_Pointer++;
     return_value[DW_Pointer] = ProdTotalWeightLT;     //48  //SADM2 2020 NOVEMBER
     DW_Pointer++;
...
int DW_Pointer; 
     ...
     DW_Pointer++;
     return_value[DW_Pointer] = ProdTotalWeight;  //SADM2 2020 NOVEMBER
     DW_Pointer++;
...
int DW_Pointer; 
     ...
     DW_Pointer++;
     return_value[DW_Pointer] = ProdTotalWeightLT;  //SADM2 2020 NOVEMBER 
     //DW_Pointer++;
...
int DW_Pointer; 
     ...
     DW_Pointer++; 
     return_value[DW_Pointer] = Batch_TotalWeight;//26  //SADM2 2020 NOVEMBER
     DW_Pointer++;
