...
void RefreshProdRepData(void)
{
  ...
  STR_ProdTotalWeightLT_Scale1 = concat(trim(adj(ProdTotalWeightLT,14,2))," ",STR_WPUnit);  //SADM2 2020 NOVEMBER
  ...
  STR_ProdTotalWeight_Scale1 = trim(adj(ProdTotalWeight,14,2));  //SADM2 2020 NOVEMBER
...
string ShowErrorMsg[40] ="", TicketInfo[256];
              ...
              TicketInfo = concat("<;", MC.SerialNbr, ";",
                           ...
                           WP.Unit+"/h", ";", 
                           trim(string(adj(ProdTotalWeight,14,2))), ";",//added by namk 04/10/2018  //SADM2 2020 NOVEMBER
