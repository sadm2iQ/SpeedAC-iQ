...
#include "SpeedACiQ_IP_V3.2.3c.h"
...
string  Name[24];
string  Details[48];
string  TotalWeight[14];  //SADM2 2020 NOVEMBER
string  BeginTime[22];
string  EndTime[22];
decimal Residue%6.2;
decimal StdDev%6.4;
...
double       ProdTotalWeight%14.2;  //SADM2 2020 NOVEMBER
decimal      ProdLastChecked%7.3[2], ProdLastWeight%7.3[2];

//LifeTime Production Data
decimal      ProdTotalWeighmentsLT%10.0[2],ProdTotalUnitsLT%10.0[2];  //SADM2 2020 NOVEMBER
...
double Batch_TotalWeight;  //SADM2 2020 NOVEMBER
