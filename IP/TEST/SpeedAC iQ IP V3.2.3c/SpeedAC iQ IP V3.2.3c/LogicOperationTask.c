...
bool FirstChecked;
  ...
  */
  ...
  if(!FirstChecked)
  {
    ...
    if(LastShiftTotalWeightLT == 0) LastShiftTotalWeightLT = ProdTotalWeightLT;  //SADM2 2020 NOVEMBER
    if(LastShiftTotalUnitsLT == 0) LastShiftTotalUnitsLT = ProdTotalUnitsLT[Scale1];
    if(LastHourlyTotalWeightLT == 0)LastHourlyTotalWeightLT = ProdTotalWeightLT;  //SADM2 2020 NOVEMBER
  ...
  {   
    ProdTotalWeightOfShift = ProdTotalWeightLT- LastShiftTotalWeightLT;  //SADM2 2020 NOVEMBER
    ProdTotalUnitOfShift = ProdTotalUnitsLT[Scale1]- LastShiftTotalUnitsLT;
    LastShiftTotalWeightLT = ProdTotalWeightLT;  //SADM2 2020 NOVEMBER
  ...
  {
    ProdTotalWeightOfHourly = ProdTotalWeightLT- LastHourlyTotalWeightLT;  //SADM2 2020 NOVEMBER
    ProdTotalUnitOfHourly = ProdTotalUnitsLT[Scale1] - LastHourlyTotalUnitsLT; 
    CurrentShiftUsageWeight = ProdTotalWeightOfShift+(ProdTotalWeightLT - ProdTotalWeightOfShift);  //SADM2 2020 NOVEMBER
    LastHourlyTotalWeightLT = ProdTotalWeightLT;  //SADM2 2020 NOVEMBER
