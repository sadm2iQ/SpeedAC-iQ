...
void RefreshAutoScreenDataByMode(void)
{
  ...
  decimal ProdFeedRateTemp%10.4,MaxFeedRateTemp%10.4;
  decimal ProdEvalFeedRateTemp%10.4,PresetFeedRateTemp%10.4;
  ...
  switch(MC.WeighingMode)
  {
    case Monitoring:
         ...
         widget_text    (AUTO_ROW15_OUTPUT, adj(MaxFeedRateTemp,10,dp));         
           
         widget_text    (AUTO_ROW5_OUTPUT, adj(ProdFeedRateTemp,10,dp));           
    ...
    case TimeControl:        
         ...
         widget_text       (AUTO_ROW15_OUTPUT, adj(ProdEvalFeedRateTemp,10,dp));     
    ...
    case FeedRateControl:
         ...
         widget_text       (AUTO_ROW15_OUTPUT, adj(PresetFeedRateTemp,10,dp)); 
    ...
    case Bulk:
         if(WP.TransferSilo == YES && WP.BulkModeIP == Receive)
         {
           ...
           widget_text       (AUTO_ROW15_OUTPUT, adj(ProdSiloNoWeight[ProdSiloNo],10,dp)); 
         
           widget_text    (AUTO_ROW5_OUTPUT, adj(ProdSiloNoWeight[ProdSiloDest],10,dp));           
