       ...
       // Layout of both columns
        ...
        // Layout of second column on the right 
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #2 
            ...
            beginrow(); // Second row with three columns  
              CreatePromptField   (MC_ROW8_ID,     CL_PT_BLUE, OFF,                        lsub(TX_MCCFGBAGHOLDER), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateComboBoxField (MC_ROW8_SELECT, FT_STANDARD_SIZE, FT_RTC_BOLD,   lsub(TX_WPNO), lsub(TX_MCHolderS4), lsub(TX_MCHolderBirdBeak), "", "", WD_MC_BOX, HT_MC_BOX, widget_locked);
       ...
       // Left display with weighing in-/outputs without infoline
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // Third row with three columns 
              CreatePromptField   (MC_ROW21_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCPLANTLINENAME), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField    (MC_ROW21_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_STRING, 24, 0, OFF, lsub(TX_MCPLANTLINENAME), WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW21_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "" , WD_MC_UNIT_LEFT, HT_MC_BOX, widget_locked); 
            endrow();                              
          
            beginrow(); // Fourth row with three columns  
              CreatePromptField   (MC_ROW22_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCSERIALNBR), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField    (MC_ROW22_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_STRING, 12, 0, OFF, lsub(TX_MCSERIALNBR), WD_MC_BOX, HT_MC_BOX, widget_locked );
        ...
        beginlayout(LAYOUT_TYPE_HBOX, 0,3); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); 
            ...
            beginrow(); // Fifth row with three columns  //SADM2
              ...
              CreateInputField    (MC_ROW29_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_NUMERIC_STRING, 48, 0, OFF, lsub(TX_MCSUPPORTEMAIL), WD_MC_BOX, HT_MC_BOX, widget_locked );
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // Fifth row with three columns //SADM2
              ...
              CreateInputField    (MC_ROW35_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_NUMERIC_STRING, 48, 0, OFF, lsub(TX_MCPARTSEMAIL), WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW35_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "", WD_MC_UNIT_LEFT, HT_MC_BOX, widget_locked );
              
              /*
              CreatePromptField   (MC_ROW35_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCPARTSFAXNBR), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField    (MC_ROW35_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_NUMERIC_STRING, 24, 0, OFF, lsub(TX_MCPARTSFAXNBR), WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW35_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "", WD_MC_UNIT_LEFT, HT_MC_BOX, widget_locked );*/
  ...
  {  
    ...
    case SCREEN_MC3 :  
                   ...
                   // Page 3 of 3                          
                      ...
                      case MC_ROW29_INPUT : MC.SupportEmail = CheckEmailSupport(Argument);
                                            break;
                      ...
                      //case MC_ROW35_INPUT : MC.PartsFaxNbr = Argument;
                       ...
                       case MC_ROW35_INPUT : if(Argument == "RESETREGKEY") ResetRegistryKey = Execute; 
                                            else MC.PartsEmail = CheckEmailParts(Argument);
                                            break;
