...
#include "SpeedACiQ_Net_V2.5.3c.h"
...
#define OverloadFactor 1.6  //SADM2 2020
...
bool SlowCycleOccured,IsCleanoutDone,CleanoutWeighment,DischReqInputOn, ZeroOutofRangeFlag;//SADM2
