...
beginlayout(LAYOUT_TYPE_VBOX, 0); //Test Layout #1 
    ...
    beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #2    // 
      ...
      beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #3  // 
        ...
        CreatePromptField (REPORT_SPACE_1,    CL_PT_BLUE, OFF,                       "", FT_STANDARD_SIZE, 5, HT_IO_HEADER, 0, widget_locked);    
    ...
    switch ( Scrn_No )
    {
      case SCREEN_REPORT:
          ...
          // Second Column                               
                ...
                // Third Row Info 
                widget_text       (REPORT_ROW10_INPUT, trim(adj(ProdTotalWeightLT[Scale1],14,2)));
