        ...
        // LAyout of second column of recipe page on the right  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // 3rd row with three columns
              ...
              CreateComboBoxField (RECIPE_ROW33_SELECT, FT_STANDARD_SIZE, FT_RTC_BOLD,        lsub(TX_WPALGOSTD),  lsub(TX_WPALGOSMARTIQ),lsub(TX_WPALGOSIMIQ),"","", WD_WP_BOX, HT_WP_BOX, widget_locked );
