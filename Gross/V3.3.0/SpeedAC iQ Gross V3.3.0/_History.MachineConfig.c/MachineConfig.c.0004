       ...
       // Left display with weighing in-/outputs without infoline
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // Sixth row with three columns
              CreatePromptField   (MC_ROW36_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCPARTSEMAIL), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField    (MC_ROW36_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_STRING, 24, 0, OFF, lsub(TX_MCPARTSEMAIL), WD_MC_BOX, HT_MC_BOX, widget_locked );
  ...
  switch ( Scrn_No )
  {
    ...
    case SCREEN_MC3 :
                   ...
                   // First Column                                
                    ...
                    widget_text      (MC_ROW30_INPUT, MC.SupportEmail);
