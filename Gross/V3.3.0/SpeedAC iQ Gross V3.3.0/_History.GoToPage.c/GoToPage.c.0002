...
void CreateGoToPage(void) 
{
   ...
   beginlayout(LAYOUT_TYPE_VBOX, 0);      // VBOX #1
      ...
      beginlayout(LAYOUT_TYPE_HBOX, 0);   // Buttons
          ...
          DrawGenericButtons (SCREEN_GOTO, ON, 10, GOTO_FCT_BUTTON_1, BTN_NIL_WHITE, BTN_RELWGT, BTN_NIL_WHITE, BTN_AUTOTUNEDONE, 
...
void CreateInfoPage(void) 
{
 ...
 beginrow(); // Third row with three columns 
              CreatePromptField   (INFO_ROW11_ID,     CL_PT_BLUE, OFF,                   lsub(TX_INFO_FAX), FT_STANDARD_SIZE, WD_INFO_DESCRIPTION2, HT_INFO_DESCRIPTION, No_Margin, widget_unlocked);
            ...
            beginrow(); // Fourth row with three columns  
              CreatePromptField (INFO_ROW12_ID,    CL_PT_BLUE, OFF,                        lsub(TX_INFO_EMAIL) , FT_STANDARD_SIZE, WD_INFO_DESCRIPTION2, HT_INFO_DESCRIPTION, No_Margin, widget_unlocked);
            ...
            /*
            beginrow(); // Seventh row with three columns
              CreatePromptField   (INFO_ROW15_ID,     CL_PT_BLUE, OFF,                    lsub(TX_INFO_FAX), FT_STANDARD_SIZE, WD_INFO_DESCRIPTION2, HT_INFO_DESCRIPTION, No_Margin, widget_unlocked);
            ...
            beginrow(); // Eighth row with three columns
              CreatePromptField   (INFO_ROW16_ID,     CL_PT_BLUE, OFF,                    lsub(TX_INFO_EMAIL), FT_STANDARD_SIZE, WD_INFO_DESCRIPTION2, HT_INFO_DESCRIPTION, No_Margin, widget_unlocked);
