       ...
       // Left display with weighing in-/outputs without infoline
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #2
            beginrow(); // First row with three columns 
              CreatePromptField (MP_ROW7_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MPSTABTIMELIMIT), FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW7_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 5, 2, OFF, lsub(TX_MPSTABTIMELIMIT), WD_MP_BOX, HT_MP_BOX, widget_locked );
            ...
            beginrow(); // Sixth row with three columns
              CreatePromptField (MP_ROW12_ID,    CL_PT_BLUE, OFF,                       lsub(TX_MPLOCKINGDEVICETIME) , FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField  (MP_ROW12_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_MPLOCKINGDEVICETIME), WD_MP_BOX, HT_MP_BOX, widget_locked );
 ...
 begindraw(); 
  ...
  switch ( Scrn_No )
  {
    case SCREEN_MP1 :  
                  ...
                  // Second Column                               
                    widget_text (MP_ROW7_INPUT, MP.StabTimeLimit);
                    ...
                    widget_text (MP_ROW12_INPUT, MP.LockingDeviceTime);
  ...
  {  
    case SCREEN_MP1 :  
                   ...
                   // Page 1 of 2
                      ...
                      case MP_ROW7_INPUT :  MP.StabTimeLimit = decimal (Lim(0.01,20,Argument));
                                            break;
                      ...
                      case MP_ROW12_INPUT : MP.LockingDeviceTime = decimal (Lim(0,60,Argument));
                                            break;                 
                   }
                 break;  
