...
/**************************************************************************** 
  Variables
*****************************************************************************/
#include "SpeedACiQ_Gross_V3.3.0.h"
...
bool        InitiQSmart,InitiQFlash,iQOutputEnabled,InitPLoop,InitCPSmSwitchTime;  
