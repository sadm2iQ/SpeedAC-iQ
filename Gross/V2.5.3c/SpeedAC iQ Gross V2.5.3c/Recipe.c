                      ...
                      {      
                        ...
                        case RECIPE_ROW1_INPUT :   
                                                ...
                                                //Autotracking feature 
                                                  ...
                                                  WP.IntermCutoff    = Lim(0,(WP.BulkCutoff + 1),(WP.IntermCutoff - NominalWeightOffset + 1)); //SADM2 2021
                                                  break;
                        ...
                        case RECIPE_ROW9_INPUT :  WP.IntermCutoff = Lim(0,WP.Cutoff,Argument);  //SAMD2 2020 NOVEMBER
                                                  break;
