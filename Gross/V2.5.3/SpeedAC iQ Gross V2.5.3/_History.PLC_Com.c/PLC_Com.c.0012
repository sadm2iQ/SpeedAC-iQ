...
--  
--  Purpose           : Displays additional Live Info if No Screen is requested
--                    : 
--  Value Parameters  :
--  Variable Params   : 
                      : 
...
void Display_AdditionalLiveInfo(void)
{
  int DW_Pointer; 
     ...
     DW_Pointer++; 
     return_value[DW_Pointer] = 0;                         //24   
     DW_Pointer++;
     return_value[DW_Pointer] = 0;                         //26   
     DW_Pointer++;
...
int DW_Pointer; 
     ...
     DW_Pointer++;
     return_value[DW_Pointer] = WP.FixedBagWeight;
     DW_Pointer++;
     return_value[DW_Pointer] = WP.MaxBagWeight;
     DW_Pointer++; 
...
int DW_Pointer; 
     ...
     DW_Pointer++;
     return_value[DW_Pointer] = WP.PostFillingTime;
}
...
int DW_Pointer; 
     ...
     DW_Pointer++;
     return_value[DW_Pointer] = WP.KnockingTime;
     DW_Pointer++;
     return_value[DW_Pointer] = WP.EvacuationDelay;
     DW_Pointer++;
     return_value[DW_Pointer] = WP.EvacuationTime;
     DW_Pointer++; 
     return_value[DW_Pointer] = WP.LanceBlowOffTime;
     DW_Pointer++;
     return_value[DW_Pointer] = WP.BagReleaseDelay;
     DW_Pointer++;
     return_value[DW_Pointer] = WP.AspirationTime;
     DW_Pointer++;
...
int DW_Pointer; 
     ...
     DW_Pointer++;
     return_value[DW_Pointer] = MP.LockingDeviceTime;     
}
