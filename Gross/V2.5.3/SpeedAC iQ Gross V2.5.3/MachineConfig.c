       ...
       // Layout of both columns
        ...
        // Layout of second column on the right 
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // Grid Layout #2 
            ...
            beginrow(); // Second row with three columns  
              CreatePromptField   (MC_ROW8_ID,     CL_PT_BLUE, OFF,                        lsub(TX_MCBAGHOLDER), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateComboBoxField (MC_ROW8_SELECT, FT_STANDARD_SIZE, FT_RTC_BOLD,   lsub(TX_WPNO), lsub(TX_WPYES),"" , "", "", WD_MC_BOX, HT_MC_BOX, widget_locked);
            ...
            beginrow(); // Third row with three columns 
              CreatePromptField   (MC_ROW9_ID,    CL_PT_BLUE, OFF,                            lsub(TX_MCACTUATORPOSINVERT) , FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Fourth row with three columns  
              CreatePromptField (MC_ROW10_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MCACTUATOREXTENDLIMIT), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (MC_ROW10_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 2, 0, OFF, lsub(TX_MCACTUATOREXTENDLIMIT), WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField   (MC_ROW10_UNIT,  FT_RTC_BOLD, FT_SMALL_SIZE,                              lsub(TX_PERC_UNIT), WD_MC_UNIT, HT_MC_BOX, widget_locked );
            endrow();         
       ...
       // Left display with weighing in-/outputs without infoline
        beginlayout(LAYOUT_TYPE_HBOX, 0,3); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); 
            ...
            beginrow(); // Thirth row with three columns
              CreatePromptField   (MC_ROW15_ID,     CL_PT_BLUE, OFF,                    lsub(TX_MCAUTOSAVECORRECTION), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, Left_Margin, widget_locked);
            ...
            beginrow(); // Fourth row with three columns
              CreatePromptField (MC_ROW16_ID,    CL_PT_BLUE, OFF,                        lsub(TX_MCDISCHREQDEBOUNCING), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField  (MC_ROW16_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 4, 2, OFF, lsub(TX_MCDISCHREQDEBOUNCING), WD_MC_BOX, HT_MC_BOX, widget_locked );
            ...
            beginrow(); // Sixth row with three columns
              CreatePromptField   (MC_ROW18_ID,     CL_PT_BLUE, OFF,                    lsub(TX_PrinterIP), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField    (MC_ROW18_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_STRING, 15, 0, OFF, lsub(TX_PrinterIP), WD_MC_BOX, HT_MC_BOX, widget_locked );
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            beginrow(); // First row with three columns  
              CreatePromptField   (MC_ROW19_ID,     CL_PT_BLUE, OFF,                    lsub(TX_MCDRIBBLEOUTONINBULK), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateComboBoxField (MC_ROW19_SELECT, FT_STANDARD_SIZE, FT_RTC_BOLD,        lsub(TX_OFF), lsub(TX_ON), "", "", "", WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW19_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                          "" , WD_MC_UNIT_LEFT, HT_MC_BOX, widget_locked);
            endrow();    
            
            beginrow(); // Second row with three columns 
              CreatePromptField   (MC_ROW20_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCPLANTLINENAME), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField    (MC_ROW20_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_STRING, 24, 0, OFF, lsub(TX_MCPLANTLINENAME), WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW20_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "" , WD_MC_UNIT_LEFT, HT_MC_BOX, widget_locked); 
            endrow();                              
          
            beginrow(); // Third row with three columns  
              CreatePromptField   (MC_ROW21_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCSERIALNBR), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField    (MC_ROW21_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_STRING, 12, 0, OFF, lsub(TX_MCSERIALNBR), WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW21_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "" , WD_MC_UNIT_LEFT, HT_MC_BOX, widget_locked); 
            endrow();            

            beginrow(); // Fourth row with three columns 
              CreatePromptField   (MC_ROW22_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCCUSTOMERNAME), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField    (MC_ROW22_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_STRING, 24, 0, OFF, lsub(TX_MCCUSTOMERNAME), WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW22_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                           "" , WD_MC_UNIT_LEFT, HT_MC_BOX, widget_locked);      
            endrow();  

            beginrow(); // Fifth row with three columns
              CreatePromptField   (MC_ROW23_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCCUSTOMERLOCATION), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, No_Margin, widget_locked);
              CreateInputField    (MC_ROW23_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_STRING, 24, 0, OFF, lsub(TX_MCCUSTOMERLOCATION), WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW23_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                            "", WD_MC_UNIT_LEFT, HT_MC_BOX, widget_locked );
            endrow();
            
            beginrow(); // Sixth row with three colums
              CreatePromptField     (MC_ROW24_ID,     CL_PT_BLUE, OFF,                  "", FT_STANDARD_SIZE, WD_MP_DESCRIPTION, HT_MP_DESCRIPTION, Left_Margin, widget_locked);
              CreateOutputTextField (MC_ROW24_INPUT,                                      "", WD_MP_BOX, HT_MP_BOX, widget_locked);
              CreateUnitField       (MC_ROW24_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,       "", WD_UNIT, HT_MP_BOX, widget_locked );
            endrow(); 
       ...
       // Left display with weighing in-/outputs without infoline
        beginlayout(LAYOUT_TYPE_HBOX, 0,3); // HBOX #6
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); 
            ...
            beginrow(); // Third row with three columns
              CreatePromptField   (MC_ROW27_ID,     CL_PT_BLUE, OFF,                      lsub(TX_MCPASSWORDPT), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, Left_Margin, widget_locked);
              CreateInputField    (MC_ROW27_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 8, 0, OFF, lsub(TX_MCPASSWORDPT), WD_MC_BOX, HT_MC_BOX, widget_locked );
        ...
        // Second Column of recipe page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            ...
            endrow();            
             ...
             beginrow(); // Fifth row with three columns //SADM2
              ...
              CreateInputField    (MC_ROW35_INPUT,  FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_NUMERIC_STRING, 24, 0, OFF, lsub(TX_MCPARTSEMAIL), WD_MC_BOX, HT_MC_BOX, widget_locked );
            ...
            beginrow(); // Sixth row with three columns
              //SADM2
              CreatePromptField   (MC_ROW36_ID,     CL_PT_BLUE, OFF,                    lsub(TX_MCUSBMOUSE), FT_STANDARD_SIZE, WD_MC_DESCRIPTION, HT_MC_DESCRIPTION, Left_Margin, widget_locked);
              CreateComboBoxField (MC_ROW36_SELECT, FT_STANDARD_SIZE, FT_RTC_BOLD,        lsub(TX_OFF), lsub(TX_ON), "", "", "", WD_MC_BOX, HT_MC_BOX, widget_locked );
              CreateUnitField     (MC_ROW36_UNIT,   FT_RTC_BOLD, FT_STANDARD_SIZE,                          "" , WD_MC_UNIT, HT_MC_BOX, widget_locked);
  ...
  switch ( Scrn_No )
  {
    case SCREEN_MC1 :  
                  ...
                  // Second Column                               
                    ...
                    widget_set_index (MC_ROW8_SELECT, MC.CFGBagHolder,0);
                    widget_set_index (MC_ROW9_SELECT, MC.ActuatorPosInvert,0);
                    
                    widget_text (MC_ROW10_INPUT, MC.ActuatorExtendLimit);
    ...
    case SCREEN_MC2 :    
                  ...
                  // First Column                                 
                   ...
                   // Second Column                               
                    widget_set_index (MC_ROW19_SELECT, MC.DribbleOutOnInBulk,0);            
                    widget_text      (MC_ROW20_INPUT, MC.PlantLineName);
                    widget_text      (MC_ROW21_INPUT, MC.SerialNbr);
                    widget_text      (MC_ROW22_INPUT, MC.CustomerName);                  
                    widget_text      (MC_ROW23_INPUT, MC.CustomerLocation);                   
    ...
    case SCREEN_MC3 :
                  ...
                  // Second Column
                    ...
                    //SADM2
                    widget_set_index (MC_ROW36_SELECT, MC.Mouse,0);
  ...
  {  
    case SCREEN_MC1 :  
                   ...
                   // Page 1 of 3
                      ...
                      case MC_ROW10_INPUT :  MC.ActuatorExtendLimit = decimal (Lim(0,90, Argument));
                                            break;  
    ...
    case SCREEN_MC2 :  
                   ...
                   // Page 2 of 3                                                        
                      ...
                      case MC_ROW18_INPUT : MC.PrinterIP = CheckPrinterIP(Argument);
                                              break;
                      case MC_ROW20_INPUT : MC.PlantLineName = Argument;
                                            break; 
                                             
                      case MC_ROW21_INPUT : MC.SerialNbr = Argument;
                                            break;   
                      
                      case MC_ROW22_INPUT : MC.CustomerName = Argument;
                                            break;
                                            
                      case MC_ROW23_INPUT : MC.CustomerLocation = Argument;
                                            break;                                                                     
 ...
 begindraw();
  ...
  {  
    case SCREEN_MC1 :  
                   ...
                   {       
                      ...
                      case MC_ROW7_SELECT :   MC.FeederType = Feeder.ListNbr[int (Argument)];
                                              ...
                                              break;
                      case MC_ROW8_SELECT :   MC.CFGBagHolder = int (Argument);
                                              break;
                      case MC_ROW9_SELECT :   MC.ActuatorPosInvert = int (Argument);
                                              break;
    ...
    case SCREEN_MC2 :  
                   ...
                   {      
                      ...
                      case MC_ROW17_SELECT :  ContOutETHEditOK = CheckContOut(MC.PortCOM2Cfg,int (Argument));
                                              ...
                                              break;                
                      case MC_ROW19_SELECT :  MC.DribbleOutOnInBulk = int (Argument);
                                              break;                                                                                             
                   }
                 break; 
    ...
    case SCREEN_MC3 :  
                   switch (value)
                   {      
                      case MC_ROW36_SELECT : MC.Mouse = int(Argument);
                                             CursorModeSet();
                                            break;                           
