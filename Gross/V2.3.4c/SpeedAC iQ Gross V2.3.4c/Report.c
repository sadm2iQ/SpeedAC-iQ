...
beginlayout(LAYOUT_TYPE_VBOX, 0); //Test Layout #1 
    ...
    beginlayout(LAYOUT_TYPE_HBOX, 0); // HBOX #2    // 
      ...
      beginlayout(LAYOUT_TYPE_VBOX, 0); // VBOX #3  // 
        ...
        CreatePromptField (REPORT_SPACE_1,    CL_PT_BLUE, OFF,                       "", FT_STANDARD_SIZE, 60, HT_IO_HEADER, 0, widget_locked);    
        ...
        // Second Column of REPORT page  
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,1); // 
            ...
            beginrow(); // First row with three colons 
              CreatePromptField (REPORT_ROW8_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_TOTAL_UNITS), FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
            ...
            beginrow(); // Second row with three colons
              CreatePromptField (REPORT_ROW9_ID,    CL_PT_BLUE, OFF, lsub(TX_ID_TOTAL_WEIGHT), FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
              ...
              CreateUnitField   (REPORT_ROW9_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,          "", WP.Unit, HT_REPORT_BOX, widget_locked );
            endrow();
      
            beginrow(); // Third row with three colons
              CreatePromptField (REPORT_ROW10_ID,    CL_PT_BLUE, OFF, "", FT_STANDARD_SIZE, WD_REPORT_COLUMN3, HT_REPORT_DESCRIPTION, No_Margin, widget_locked);
              ...
              CreateUnitField   (REPORT_ROW10_UNIT,  FT_RTC_BOLD, FT_STANDARD_SIZE,          "", WD_UNIT, HT_REPORT_BOX, widget_locked );
            endrow();
      ...
      case SCREEN_REPORT:
          ...
          // First Column                                
               ...
               widget_text         (REPORT_ROW7_INPUT,  concat("(",lsub(WP.Name),")"));
                ...
                // Sixth Row Info 
                widget_text       (REPORT_ROW6_INPUT, trim(adj(ProdTotalWeight[Scale1],14,2)));
                widget_text       (REPORT_ROW6_UNIT,  WP.Unit);
                
          // Second Column                               
                                                
                // First Row Info 
                widget_text       (REPORT_ROW8_INPUT, ProdTotalUnitsLT[Scale1]);
                widget_text       (REPORT_ROW8_UNIT,  "");
          
                // 2nd Row Info 
                widget_text       (REPORT_ROW9_INPUT, trim(adj(ProdTotalWeightLT[Scale1],14,2)));
