  ...
  {  
    ...
    case SCREEN_MP2 :  
                   ...
                   // Page 2 of 2                          
                      ...
                      case MP_ROW19_INPUT : MP.SlowFilterSize = decimal (Lim(MP.FastFilterSize,40,Argument));
                                            break;                      
                       
                      case MP_ROW20_INPUT : MP.FastFilterSize = decimal (Lim(1,MP.SlowFilterSize,Argument));
                                            break;
                      ...
                      case MP_ROW23_INPUT : MP.SmartStabWindow = decimal (Lim(0.2,3,Argument));
                                            break;                     
